...
/**
 * 表示一个接收单个 float 参数的谓词（布尔值函数），该谓词可能抛出异常。
 ...
 */
@FunctionalInterface
public interface FloatSinglePredicateThrow<E extends Exception> extends FloatSinglePredicate {
    /**
     * 在给定参数上评估此谓词，可能抛出异常。
     *
     * @param input 输入参数
     ...
     */
    boolean testThrow(float input) throws E;
