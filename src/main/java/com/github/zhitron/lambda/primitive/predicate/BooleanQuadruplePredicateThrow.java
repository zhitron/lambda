...
/**
 * 表示一个接收四个 boolean 参数的谓词（布尔值函数），该谓词可能抛出异常。
 ...
 */
@FunctionalInterface
public interface BooleanQuadruplePredicateThrow<E extends Exception> extends BooleanQuadruplePredicate {
    /**
     * 在给定参数上评估此谓词，可能抛出异常。
     *
     * @param input   第一个输入参数
     ...
     */
    boolean testThrow(boolean input, boolean value, boolean other, boolean another) throws E;
     ...
     */
    @Override
    default boolean test(boolean input, boolean value, boolean other, boolean another) {
        try {
