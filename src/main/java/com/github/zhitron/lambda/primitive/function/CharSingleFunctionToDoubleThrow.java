...
/**
 * 表示一个接收单个 char 参数并生成结果的函数，该谓词可能抛出异常。
 ...
 */
@FunctionalInterface
public interface CharSingleFunctionToDoubleThrow<E extends Exception> extends CharSingleFunctionToDouble {
    /**
     * 在给定参数上生成结果，可能抛出异常。
     *
     * @param input 输入参数
     ...
     */
    char applyThrow(char input) throws E;
