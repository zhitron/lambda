 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongBooleanDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongBooleanDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanDoubleToChar constant(char value) {
     ...
     */
    char apply(long v1, boolean v2, double v3);
}
