 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectLongIntToInt<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionObjectLongIntToInt<?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <T> TripleFunctionObjectLongIntToInt<T> empty() {
        return (TripleFunctionObjectLongIntToInt<T>) EMPTY;
    }
     ...
     */
    static <T> TripleFunctionObjectLongIntToInt<T> constant(int value) {
