 ...
 */
@FunctionalInterface
public interface SingleFunctionIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    SingleFunctionIntToInt EMPTY = (v1) -> BasicConstant.INT_ZERO;
     ...
     */
    static SingleFunctionIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionIntToInt constant(int value) {
        return (v1) -> value;
    }
