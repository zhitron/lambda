 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntTwLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntTwLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwLongToByte constant(byte value) {
     ...
     */
    byte apply(int v1, long v2, long v3);
}
