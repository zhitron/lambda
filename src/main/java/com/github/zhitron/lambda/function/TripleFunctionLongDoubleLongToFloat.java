 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongDoubleLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongDoubleLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleLongToFloat constant(float value) {
     ...
     */
    float apply(long v1, double v2, long v3);
}
