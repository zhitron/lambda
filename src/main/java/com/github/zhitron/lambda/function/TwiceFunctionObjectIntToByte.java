 ...
 */
@FunctionalInterface
public interface TwiceFunctionObjectIntToByte<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionObjectIntToByte<?> EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
    ...
    static <T> TwiceFunctionObjectIntToByte<T> empty() {
        return (TwiceFunctionObjectIntToByte<T>) EMPTY;
    }
     ...
     */
    static <T> TwiceFunctionObjectIntToByte<T> constant(byte value) {
        return (v1, v2) -> value;
    }
