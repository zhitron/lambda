 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntDoubleLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntDoubleLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleLongToFloat constant(float value) {
     ...
     */
    float apply(int v1, double v2, long v3);
}
