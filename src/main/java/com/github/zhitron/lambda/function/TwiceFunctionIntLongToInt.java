 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionIntLongToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionIntLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntLongToInt constant(int value) {
        return (v1, v2) -> value;
    }
