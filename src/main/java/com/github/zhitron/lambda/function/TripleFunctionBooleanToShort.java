 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanToShort constant(short value) {
     ...
     */
    short apply(boolean v1, boolean v2, boolean v3);
}
