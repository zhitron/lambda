 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleLongBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleLongBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongBooleanToShort constant(short value) {
     ...
     */
    short apply(double v1, long v2, boolean v3);
}
