 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwLongBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwLongBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongBooleanToShort constant(short value) {
     ...
     */
    short apply(long v1, long v2, boolean v3);
}
