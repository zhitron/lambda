 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwIntLongIntToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongIntToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, long v3, int v4);
}
