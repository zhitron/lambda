 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwLongDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwLongDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongDoubleToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, double v3);
}
