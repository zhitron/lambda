 ...
 */
@FunctionalInterface
public interface SingleFunctionByteToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    SingleFunctionByteToLong EMPTY = (v1) -> BasicConstant.LONG_ZERO;
     ...
     */
    static SingleFunctionByteToLong empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionByteToLong constant(long value) {
        return (v1) -> value;
    }
