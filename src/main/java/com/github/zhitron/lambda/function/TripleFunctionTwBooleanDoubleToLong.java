 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwBooleanDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwBooleanDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanDoubleToLong constant(long value) {
     ...
     */
    long apply(boolean v1, boolean v2, double v3);
}
