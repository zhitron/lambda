 ...
 */
@FunctionalInterface
public interface SingleFunctionShortToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    SingleFunctionShortToByte EMPTY = (v1) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static SingleFunctionShortToByte empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionShortToByte constant(byte value) {
        return (v1) -> value;
    }
