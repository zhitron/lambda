 ...
 */
@FunctionalInterface
public interface SingleFunctionDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    SingleFunctionDoubleToDouble EMPTY = (v1) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static SingleFunctionDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionDoubleToDouble constant(double value) {
        return (v1) -> value;
    }
