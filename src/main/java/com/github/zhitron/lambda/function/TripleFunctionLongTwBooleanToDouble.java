 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongTwBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongTwBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwBooleanToDouble constant(double value) {
     ...
     */
    double apply(long v1, boolean v2, boolean v3);
}
