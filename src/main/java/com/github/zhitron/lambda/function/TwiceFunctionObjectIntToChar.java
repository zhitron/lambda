...
public interface TwiceFunctionObjectIntToChar<T> {
     ...
     */
    TwiceFunctionObjectIntToChar<?> EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
    ...
    static <T> TwiceFunctionObjectIntToChar<T> empty() {
        return (TwiceFunctionObjectIntToChar<T>) EMPTY;
    }
     ...
     */
    static <T> TwiceFunctionObjectIntToChar<T> constant(char value) {
        return (v1, v2) -> value;
    }
