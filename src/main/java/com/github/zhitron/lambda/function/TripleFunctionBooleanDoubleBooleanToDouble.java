 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanDoubleBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, double v2, boolean v3);
}
