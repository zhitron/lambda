 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleToDouble constant(double value) {
