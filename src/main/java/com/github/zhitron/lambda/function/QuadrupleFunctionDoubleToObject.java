 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionDoubleToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    QuadrupleFunctionDoubleToObject<?> EMPTY = (v1, v2, v3, v4) -> null;
    ...
    static <R> QuadrupleFunctionDoubleToObject<R> empty() {
        return (QuadrupleFunctionDoubleToObject<R>) EMPTY;
    }
     ...
     */
    static <R> QuadrupleFunctionDoubleToObject<R> constant(R value) {
     ...
     */
    R apply(double v1, double v2, double v3, double v4);
}
