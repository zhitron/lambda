 ...
 */
@FunctionalInterface
public interface TripleFunctionTwObjectLongToInt<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwObjectLongToInt<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectLongToInt<T, U> empty() {
        return (TripleFunctionTwObjectLongToInt<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectLongToInt<T, U> constant(int value) {
