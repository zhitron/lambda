 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwIntLongBooleanToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, long v3, boolean v4);
}
