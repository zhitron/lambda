 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwIntBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwIntBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntBooleanToLong constant(long value) {
     ...
     */
    long apply(int v1, int v2, boolean v3);
}
