 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanLongDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanLongDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongDoubleToLong constant(long value) {
     ...
     */
    long apply(boolean v1, long v2, double v3);
}
