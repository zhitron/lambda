 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionTwLongIntDoubleToChar EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntDoubleToChar constant(char value) {
     ...
     */
    char apply(long v1, long v2, int v3, double v4);
}
