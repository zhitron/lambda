 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionBooleanLongToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionBooleanLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanLongToLong constant(long value) {
        return (v1, v2) -> value;
    }
