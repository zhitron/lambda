 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongTwIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongTwIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwIntToByte constant(byte value) {
     ...
     */
    byte apply(long v1, int v2, int v3);
}
