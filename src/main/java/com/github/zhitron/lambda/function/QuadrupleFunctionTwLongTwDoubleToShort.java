 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwLongTwDoubleToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwDoubleToShort constant(short value) {
     ...
     */
    short apply(long v1, long v2, double v3, double v4);
}
