 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongDoubleLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwLongDoubleLongToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongDoubleLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongDoubleLongToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, double v3, long v4);
}
