 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntLongBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntLongBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongBooleanToLong constant(long value) {
     ...
     */
    long apply(int v1, long v2, boolean v3);
}
