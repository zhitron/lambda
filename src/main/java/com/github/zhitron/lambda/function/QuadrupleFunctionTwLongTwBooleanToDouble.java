 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwLongTwBooleanToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwBooleanToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, boolean v3, boolean v4);
}
