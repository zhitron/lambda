 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanIntDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanIntDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntDoubleToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, int v2, double v3);
}
