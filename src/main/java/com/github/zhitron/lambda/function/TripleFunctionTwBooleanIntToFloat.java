 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwBooleanIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwBooleanIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanIntToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, boolean v2, int v3);
}
