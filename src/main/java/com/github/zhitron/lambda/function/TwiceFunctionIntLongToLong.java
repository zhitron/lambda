 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionIntLongToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionIntLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntLongToLong constant(long value) {
        return (v1, v2) -> value;
    }
