 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleBooleanLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanLongToLong constant(long value) {
     ...
     */
    long apply(double v1, boolean v2, long v3);
}
