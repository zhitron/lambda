 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionBooleanLongToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionBooleanLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanLongToDouble constant(double value) {
        return (v1, v2) -> value;
    }
