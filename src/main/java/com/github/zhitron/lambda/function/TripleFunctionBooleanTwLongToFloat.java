 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanTwLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanTwLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwLongToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, long v2, long v3);
}
