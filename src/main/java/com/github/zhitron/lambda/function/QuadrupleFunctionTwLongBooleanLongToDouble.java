 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanLongToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, boolean v3, long v4);
}
