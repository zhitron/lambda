 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleBooleanDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToChar constant(char value) {
     ...
     */
    char apply(double v1, boolean v2, double v3);
}
