 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongTwBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongTwBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwBooleanToShort constant(short value) {
     ...
     */
    short apply(long v1, boolean v2, boolean v3);
}
