 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongTwIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongTwIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwIntToInt constant(int value) {
     ...
     */
    int apply(long v1, int v2, int v3);
}
