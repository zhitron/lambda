 ...
 */
@FunctionalInterface
public interface TripleFunctionLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, long v3);
}
