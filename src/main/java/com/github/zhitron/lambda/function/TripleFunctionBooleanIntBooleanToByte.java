 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanIntBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanIntBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntBooleanToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, int v2, boolean v3);
}
