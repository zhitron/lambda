 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwIntLongDoubleToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, long v3, double v4);
}
