 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongTwBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongTwBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwBooleanToFloat constant(float value) {
     ...
     */
    float apply(long v1, boolean v2, boolean v3);
}
