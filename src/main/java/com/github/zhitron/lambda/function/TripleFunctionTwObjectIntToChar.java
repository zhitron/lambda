 ...
 */
@FunctionalInterface
public interface TripleFunctionTwObjectIntToChar<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwObjectIntToChar<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectIntToChar<T, U> empty() {
        return (TripleFunctionTwObjectIntToChar<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectIntToChar<T, U> constant(char value) {
