 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntBooleanDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntBooleanDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanDoubleToChar constant(char value) {
     ...
     */
    char apply(int v1, boolean v2, double v3);
}
