 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntBooleanToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionIntBooleanToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionIntBooleanToObject<R> empty() {
        return (TwiceFunctionIntBooleanToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionIntBooleanToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
