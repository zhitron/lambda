 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongIntLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongIntLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntLongToByte constant(byte value) {
     ...
     */
    byte apply(long v1, int v2, long v3);
}
