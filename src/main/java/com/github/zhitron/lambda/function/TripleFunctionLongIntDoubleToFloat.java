 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongIntDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongIntDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntDoubleToFloat constant(float value) {
     ...
     */
    float apply(long v1, int v2, double v3);
}
