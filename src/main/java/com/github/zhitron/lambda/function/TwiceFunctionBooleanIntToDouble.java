 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionBooleanIntToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionBooleanIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanIntToDouble constant(double value) {
        return (v1, v2) -> value;
    }
