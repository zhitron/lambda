 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionLongDoubleToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionLongDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongDoubleToDouble constant(double value) {
        return (v1, v2) -> value;
    }
