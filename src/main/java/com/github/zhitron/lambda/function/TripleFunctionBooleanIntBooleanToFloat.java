 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanIntBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanIntBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntBooleanToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, int v2, boolean v3);
}
