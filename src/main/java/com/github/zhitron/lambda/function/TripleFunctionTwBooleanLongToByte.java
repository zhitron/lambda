 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwBooleanLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwBooleanLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanLongToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, boolean v2, long v3);
}
