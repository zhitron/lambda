 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongTwDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongTwDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwDoubleToShort constant(short value) {
     ...
     */
    short apply(long v1, double v2, double v3);
}
