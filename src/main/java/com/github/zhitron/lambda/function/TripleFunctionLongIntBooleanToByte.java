 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongIntBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongIntBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntBooleanToByte constant(byte value) {
     ...
     */
    byte apply(long v1, int v2, boolean v3);
}
