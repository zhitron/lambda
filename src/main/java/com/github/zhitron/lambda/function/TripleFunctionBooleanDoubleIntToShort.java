 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanDoubleIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleIntToShort constant(short value) {
     ...
     */
    short apply(boolean v1, double v2, int v3);
}
