 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwDoubleLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwDoubleLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleLongToChar constant(char value) {
     ...
     */
    char apply(double v1, double v2, long v3);
}
