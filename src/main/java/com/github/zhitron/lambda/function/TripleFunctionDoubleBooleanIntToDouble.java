 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleBooleanIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanIntToDouble constant(double value) {
     ...
     */
    double apply(double v1, boolean v2, int v3);
}
