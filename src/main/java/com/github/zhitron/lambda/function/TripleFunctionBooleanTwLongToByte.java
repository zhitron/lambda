 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanTwLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanTwLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwLongToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, long v2, long v3);
}
