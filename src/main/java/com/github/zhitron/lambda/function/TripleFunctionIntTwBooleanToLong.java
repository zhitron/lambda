 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntTwBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntTwBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwBooleanToLong constant(long value) {
     ...
     */
    long apply(int v1, boolean v2, boolean v3);
}
