 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwLongTwIntToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwIntToLong constant(long value) {
     ...
     */
    long apply(long v1, long v2, int v3, int v4);
}
