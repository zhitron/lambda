 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionIntBooleanToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionIntBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntBooleanToInt constant(int value) {
        return (v1, v2) -> value;
    }
