 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwLongTwIntToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwIntToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, int v3, int v4);
}
