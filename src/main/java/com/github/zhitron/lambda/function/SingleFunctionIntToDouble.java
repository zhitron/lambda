 ...
 */
@FunctionalInterface
public interface SingleFunctionIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    SingleFunctionIntToDouble EMPTY = (v1) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static SingleFunctionIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionIntToDouble constant(double value) {
        return (v1) -> value;
    }
