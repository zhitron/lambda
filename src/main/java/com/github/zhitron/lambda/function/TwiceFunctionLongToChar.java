 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionLongToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongToChar constant(char value) {
        return (v1, v2) -> value;
    }
