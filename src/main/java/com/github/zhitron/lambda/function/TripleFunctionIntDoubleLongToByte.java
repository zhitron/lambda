 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntDoubleLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntDoubleLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleLongToByte constant(byte value) {
     ...
     */
    byte apply(int v1, double v2, long v3);
}
