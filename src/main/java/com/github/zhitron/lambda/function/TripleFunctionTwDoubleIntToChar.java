 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwDoubleIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwDoubleIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleIntToChar constant(char value) {
     ...
     */
    char apply(double v1, double v2, int v3);
}
