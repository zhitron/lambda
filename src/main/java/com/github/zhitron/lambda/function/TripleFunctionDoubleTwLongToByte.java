 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleTwLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleTwLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwLongToByte constant(byte value) {
     ...
     */
    byte apply(double v1, long v2, long v3);
}
