 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntBooleanLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntBooleanLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanLongToShort constant(short value) {
     ...
     */
    short apply(int v1, boolean v2, long v3);
}
