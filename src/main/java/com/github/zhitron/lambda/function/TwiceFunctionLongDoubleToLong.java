 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionLongDoubleToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionLongDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongDoubleToLong constant(long value) {
        return (v1, v2) -> value;
    }
