 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionDoubleBooleanToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionDoubleBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleBooleanToInt constant(int value) {
        return (v1, v2) -> value;
    }
