 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongDoubleBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongDoubleBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleBooleanToFloat constant(float value) {
     ...
     */
    float apply(long v1, double v2, boolean v3);
}
