 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongIntDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongIntDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntDoubleToChar constant(char value) {
     ...
     */
    char apply(long v1, int v2, double v3);
}
