 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleToChar constant(char value) {
     ...
     */
    char apply(double v1, double v2, double v3);
}
