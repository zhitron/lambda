 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionBooleanToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanToFloat constant(float value) {
        return (v1, v2) -> value;
    }
