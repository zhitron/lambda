 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwDoubleIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwDoubleIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleIntToByte constant(byte value) {
     ...
     */
    byte apply(double v1, double v2, int v3);
}
