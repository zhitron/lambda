 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanLongDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanLongDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongDoubleToChar constant(char value) {
     ...
     */
    char apply(boolean v1, long v2, double v3);
}
