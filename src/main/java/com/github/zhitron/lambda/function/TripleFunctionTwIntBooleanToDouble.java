 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwIntBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwIntBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntBooleanToDouble constant(double value) {
     ...
     */
    double apply(int v1, int v2, boolean v3);
}
