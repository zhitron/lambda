 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleIntDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleIntDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntDoubleToByte constant(byte value) {
     ...
     */
    byte apply(double v1, int v2, double v3);
}
