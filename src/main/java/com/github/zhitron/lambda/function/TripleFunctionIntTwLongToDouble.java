 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntTwLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntTwLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwLongToDouble constant(double value) {
     ...
     */
    double apply(int v1, long v2, long v3);
}
