 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwLongIntLongToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntLongToShort constant(short value) {
     ...
     */
    short apply(long v1, long v2, int v3, long v4);
}
