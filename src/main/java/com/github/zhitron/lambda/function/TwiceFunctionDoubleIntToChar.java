 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionDoubleIntToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionDoubleIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleIntToChar constant(char value) {
        return (v1, v2) -> value;
    }
