 ...
 */
@FunctionalInterface
public interface SingleFunctionBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    SingleFunctionBooleanToFloat EMPTY = (v1) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static SingleFunctionBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionBooleanToFloat constant(float value) {
        return (v1) -> value;
    }
