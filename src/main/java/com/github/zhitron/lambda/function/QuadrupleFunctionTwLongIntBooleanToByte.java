 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwLongIntBooleanToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntBooleanToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, int v3, boolean v4);
}
