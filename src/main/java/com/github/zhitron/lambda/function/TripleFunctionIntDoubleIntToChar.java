 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntDoubleIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntDoubleIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleIntToChar constant(char value) {
     ...
     */
    char apply(int v1, double v2, int v3);
}
