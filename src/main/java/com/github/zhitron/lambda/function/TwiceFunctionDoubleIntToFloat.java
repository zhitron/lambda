 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionDoubleIntToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionDoubleIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleIntToFloat constant(float value) {
        return (v1, v2) -> value;
    }
