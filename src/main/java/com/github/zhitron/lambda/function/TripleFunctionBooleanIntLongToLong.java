 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanIntLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanIntLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntLongToLong constant(long value) {
     ...
     */
    long apply(boolean v1, int v2, long v3);
}
