 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwLongTwDoubleToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwDoubleToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, double v3, double v4);
}
