 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntBooleanDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntBooleanDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanDoubleToFloat constant(float value) {
     ...
     */
    float apply(int v1, boolean v2, double v3);
}
