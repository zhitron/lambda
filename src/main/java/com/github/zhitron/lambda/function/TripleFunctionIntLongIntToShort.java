 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntLongIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntLongIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongIntToShort constant(short value) {
     ...
     */
    short apply(int v1, long v2, int v3);
}
