 ...
 * 该接口扩展自 {@link QuadrupleFunctionLongToInt}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface QuadrupleFunctionLongToIntThrow<E extends Exception> extends QuadrupleFunctionLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionLongToIntThrow<?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
    ...
    static <E extends Exception> QuadrupleFunctionLongToIntThrow<E> empty() {
        return (QuadrupleFunctionLongToIntThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> QuadrupleFunctionLongToIntThrow<E> constant(int value) {
     ...
     * @throws E 抛出执行过程中的异常
     */
    int applyThrow(long v1, long v2, long v3, long v4) throws E;
     ...
     */
    @Override
    default int apply(long v1, long v2, long v3, long v4) {
        try {
