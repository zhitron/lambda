 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionLongIntToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionLongIntToObject<R> empty() {
        return (TwiceFunctionLongIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionLongIntToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
