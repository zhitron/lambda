 ...
 */
@FunctionalInterface
public interface SingleFunctionFloatToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    SingleFunctionFloatToInt EMPTY = (v1) -> BasicConstant.INT_ZERO;
     ...
     */
    static SingleFunctionFloatToInt empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionFloatToInt constant(int value) {
        return (v1) -> value;
    }
