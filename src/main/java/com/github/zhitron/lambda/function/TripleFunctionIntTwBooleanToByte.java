 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntTwBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntTwBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwBooleanToByte constant(byte value) {
     ...
     */
    byte apply(int v1, boolean v2, boolean v3);
}
