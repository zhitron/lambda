 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntLongBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntLongBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongBooleanToByte constant(byte value) {
     ...
     */
    byte apply(int v1, long v2, boolean v3);
}
