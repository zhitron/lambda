 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionLongTriIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    QuadrupleFunctionLongTriIntToObject<?> EMPTY = (v1, v2, v3, v4) -> null;
    ...
    static <R> QuadrupleFunctionLongTriIntToObject<R> empty() {
        return (QuadrupleFunctionLongTriIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> QuadrupleFunctionLongTriIntToObject<R> constant(R value) {
     ...
     */
    R apply(long v1, int v2, int v3, int v4);
}
