 ...
 */
@FunctionalInterface
public interface SingleFunctionDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    SingleFunctionDoubleToFloat EMPTY = (v1) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static SingleFunctionDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionDoubleToFloat constant(float value) {
        return (v1) -> value;
    }
