 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanIntBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanIntBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntBooleanToShort constant(short value) {
     ...
     */
    short apply(boolean v1, int v2, boolean v3);
}
