 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleBooleanIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanIntToByte constant(byte value) {
     ...
     */
    byte apply(double v1, boolean v2, int v3);
}
