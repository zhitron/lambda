 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwDoubleLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwDoubleLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleLongToByte constant(byte value) {
     ...
     */
    byte apply(double v1, double v2, long v3);
}
