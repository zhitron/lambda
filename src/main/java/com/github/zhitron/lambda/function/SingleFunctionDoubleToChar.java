 ...
 */
@FunctionalInterface
public interface SingleFunctionDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    SingleFunctionDoubleToChar EMPTY = (v1) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static SingleFunctionDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionDoubleToChar constant(char value) {
        return (v1) -> value;
    }
