 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwObjectTwIntToLong<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwObjectTwIntToLong<?, ?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
    ...
    static <T, U> QuadrupleFunctionTwObjectTwIntToLong<T, U> empty() {
        return (QuadrupleFunctionTwObjectTwIntToLong<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> QuadrupleFunctionTwObjectTwIntToLong<T, U> constant(long value) {
     ...
     */
    long apply(T v1, U v2, int v3, int v4);
}
