 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, boolean v2, boolean v3);
}
