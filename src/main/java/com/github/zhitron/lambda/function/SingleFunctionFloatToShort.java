 ...
 */
@FunctionalInterface
public interface SingleFunctionFloatToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    SingleFunctionFloatToShort EMPTY = (v1) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static SingleFunctionFloatToShort empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionFloatToShort constant(short value) {
        return (v1) -> value;
    }
