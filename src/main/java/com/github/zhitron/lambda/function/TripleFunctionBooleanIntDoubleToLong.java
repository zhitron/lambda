 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanIntDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanIntDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntDoubleToLong constant(long value) {
     ...
     */
    long apply(boolean v1, int v2, double v3);
}
