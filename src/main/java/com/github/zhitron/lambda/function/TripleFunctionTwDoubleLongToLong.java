 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwDoubleLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwDoubleLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleLongToLong constant(long value) {
     ...
     */
    long apply(double v1, double v2, long v3);
}
