 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanLongIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanLongIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongIntToInt constant(int value) {
     ...
     */
    int apply(boolean v1, long v2, int v3);
}
