 ...
 */
@FunctionalInterface
public interface TwiceFunctionObjectToLong<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionObjectToLong<?, ?> EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
    ...
    static <T, U> TwiceFunctionObjectToLong<T, U> empty() {
        return (TwiceFunctionObjectToLong<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TwiceFunctionObjectToLong<T, U> constant(long value) {
        return (v1, v2) -> value;
    }
