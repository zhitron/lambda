 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwObjectTwLongToInt<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwObjectTwLongToInt<?, ?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
    ...
    static <T, U> QuadrupleFunctionTwObjectTwLongToInt<T, U> empty() {
        return (QuadrupleFunctionTwObjectTwLongToInt<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> QuadrupleFunctionTwObjectTwLongToInt<T, U> constant(int value) {
     ...
     */
    int apply(T v1, U v2, long v3, long v4);
}
