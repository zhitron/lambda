 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwLongTwBooleanToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwBooleanToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, boolean v3, boolean v4);
}
