 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwLongIntDoubleToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntDoubleToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, int v3, double v4);
}
