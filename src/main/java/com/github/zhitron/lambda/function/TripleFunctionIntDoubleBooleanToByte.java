 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntDoubleBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntDoubleBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleBooleanToByte constant(byte value) {
     ...
     */
    byte apply(int v1, double v2, boolean v3);
}
