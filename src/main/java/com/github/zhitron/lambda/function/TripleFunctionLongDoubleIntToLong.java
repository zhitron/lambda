 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongDoubleIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongDoubleIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleIntToLong constant(long value) {
     ...
     */
    long apply(long v1, double v2, int v3);
}
