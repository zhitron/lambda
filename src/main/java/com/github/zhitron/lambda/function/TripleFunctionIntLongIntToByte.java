 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntLongIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntLongIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongIntToByte constant(byte value) {
     ...
     */
    byte apply(int v1, long v2, int v3);
}
