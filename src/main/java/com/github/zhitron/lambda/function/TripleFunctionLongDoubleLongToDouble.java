 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongDoubleLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongDoubleLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleLongToDouble constant(double value) {
     ...
     */
    double apply(long v1, double v2, long v3);
}
