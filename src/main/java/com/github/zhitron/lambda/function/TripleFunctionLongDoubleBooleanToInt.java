 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongDoubleBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongDoubleBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleBooleanToInt constant(int value) {
     ...
     */
    int apply(long v1, double v2, boolean v3);
}
