 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntLongBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntLongBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongBooleanToShort constant(short value) {
     ...
     */
    short apply(int v1, long v2, boolean v3);
}
