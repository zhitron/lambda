 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleBooleanLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanLongToInt constant(int value) {
     ...
     */
    int apply(double v1, boolean v2, long v3);
}
