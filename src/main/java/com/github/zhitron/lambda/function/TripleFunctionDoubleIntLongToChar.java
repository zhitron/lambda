 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleIntLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleIntLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntLongToChar constant(char value) {
     ...
     */
    char apply(double v1, int v2, long v3);
}
