 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleLongIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleLongIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongIntToShort constant(short value) {
     ...
     */
    short apply(double v1, long v2, int v3);
}
