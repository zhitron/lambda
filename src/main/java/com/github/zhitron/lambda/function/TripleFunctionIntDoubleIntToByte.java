 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntDoubleIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntDoubleIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleIntToByte constant(byte value) {
     ...
     */
    byte apply(int v1, double v2, int v3);
}
