 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongDoubleLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongDoubleLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleLongToLong constant(long value) {
     ...
     */
    long apply(long v1, double v2, long v3);
}
