 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwIntBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwIntBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntBooleanToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, boolean v3);
}
