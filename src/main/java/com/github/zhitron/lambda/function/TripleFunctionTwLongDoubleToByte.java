 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwLongDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwLongDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongDoubleToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, double v3);
}
