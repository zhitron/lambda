 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanIntDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanIntDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntDoubleToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, int v2, double v3);
}
