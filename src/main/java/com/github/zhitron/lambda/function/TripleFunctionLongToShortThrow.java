 ...
 * 该接口扩展自 {@link TripleFunctionLongToShort}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface TripleFunctionLongToShortThrow<E extends Exception> extends TripleFunctionLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongToShortThrow<?> EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
    ...
    static <E extends Exception> TripleFunctionLongToShortThrow<E> empty() {
        return (TripleFunctionLongToShortThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TripleFunctionLongToShortThrow<E> constant(short value) {
     ...
     * @throws E 抛出执行过程中的异常
     */
    short applyThrow(long v1, long v2, long v3) throws E;
     ...
     */
    @Override
    default short apply(long v1, long v2, long v3) {
        try {
