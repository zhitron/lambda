 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntBooleanLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntBooleanLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanLongToByte constant(byte value) {
     ...
     */
    byte apply(int v1, boolean v2, long v3);
}
