 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwDoubleBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwDoubleBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleBooleanToByte constant(byte value) {
     ...
     */
    byte apply(double v1, double v2, boolean v3);
}
