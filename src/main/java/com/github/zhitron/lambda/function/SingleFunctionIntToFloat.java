 ...
 */
@FunctionalInterface
public interface SingleFunctionIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    SingleFunctionIntToFloat EMPTY = (v1) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static SingleFunctionIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionIntToFloat constant(float value) {
        return (v1) -> value;
    }
