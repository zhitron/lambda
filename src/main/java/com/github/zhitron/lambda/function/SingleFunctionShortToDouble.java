 ...
 */
@FunctionalInterface
public interface SingleFunctionShortToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    SingleFunctionShortToDouble EMPTY = (v1) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static SingleFunctionShortToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionShortToDouble constant(double value) {
        return (v1) -> value;
    }
