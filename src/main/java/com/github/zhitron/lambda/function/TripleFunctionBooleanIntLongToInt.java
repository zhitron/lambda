 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanIntLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanIntLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntLongToInt constant(int value) {
     ...
     */
    int apply(boolean v1, int v2, long v3);
}
