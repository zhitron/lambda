 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanTwIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanTwIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwIntToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, int v2, int v3);
}
