 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwBooleanDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwBooleanDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanDoubleToInt constant(int value) {
     ...
     */
    int apply(boolean v1, boolean v2, double v3);
}
