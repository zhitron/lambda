 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntDoubleToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionIntDoubleToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionIntDoubleToObject<R> empty() {
        return (TwiceFunctionIntDoubleToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionIntDoubleToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
