 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanDoubleBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToInt constant(int value) {
     ...
     */
    int apply(boolean v1, double v2, boolean v3);
}
