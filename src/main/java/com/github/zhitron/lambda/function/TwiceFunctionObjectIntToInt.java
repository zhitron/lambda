 ...
 */
@FunctionalInterface
public interface TwiceFunctionObjectIntToInt<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionObjectIntToInt<?> EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
    ...
    static <T> TwiceFunctionObjectIntToInt<T> empty() {
        return (TwiceFunctionObjectIntToInt<T>) EMPTY;
    }
     ...
     */
    static <T> TwiceFunctionObjectIntToInt<T> constant(int value) {
        return (v1, v2) -> value;
    }
