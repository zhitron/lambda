 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanTwLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanTwLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwLongToInt constant(int value) {
     ...
     */
    int apply(boolean v1, long v2, long v3);
}
