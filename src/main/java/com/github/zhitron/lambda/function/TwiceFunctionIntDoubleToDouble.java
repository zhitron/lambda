 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionIntDoubleToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionIntDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntDoubleToDouble constant(double value) {
        return (v1, v2) -> value;
    }
