 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongDoubleIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongDoubleIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleIntToShort constant(short value) {
     ...
     */
    short apply(long v1, double v2, int v3);
}
