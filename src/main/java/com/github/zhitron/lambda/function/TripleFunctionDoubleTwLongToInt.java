 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleTwLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleTwLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwLongToInt constant(int value) {
     ...
     */
    int apply(double v1, long v2, long v3);
}
