 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanTwIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanTwIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwIntToLong constant(long value) {
     ...
     */
    long apply(boolean v1, int v2, int v3);
}
