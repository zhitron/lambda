 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongDoubleIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongDoubleIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleIntToDouble constant(double value) {
     ...
     */
    double apply(long v1, double v2, int v3);
}
