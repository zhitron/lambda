 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleTwBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleTwBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwBooleanToChar constant(char value) {
     ...
     */
    char apply(double v1, boolean v2, boolean v3);
}
