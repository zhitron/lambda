 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwLongIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwLongIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongIntToLong constant(long value) {
     ...
     */
    long apply(long v1, long v2, int v3);
}
