 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanLongToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionBooleanLongToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionBooleanLongToObject<R> empty() {
        return (TwiceFunctionBooleanLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionBooleanLongToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
