 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwIntBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwIntBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntBooleanToByte constant(byte value) {
     ...
     */
    byte apply(int v1, int v2, boolean v3);
}
