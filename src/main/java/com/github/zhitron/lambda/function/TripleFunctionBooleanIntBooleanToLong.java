 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanIntBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanIntBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntBooleanToLong constant(long value) {
     ...
     */
    long apply(boolean v1, int v2, boolean v3);
}
