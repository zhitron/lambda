 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanLongBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanLongBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongBooleanToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, long v2, boolean v3);
}
