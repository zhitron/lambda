 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongBooleanIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongBooleanIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanIntToDouble constant(double value) {
     ...
     */
    double apply(long v1, boolean v2, int v3);
}
