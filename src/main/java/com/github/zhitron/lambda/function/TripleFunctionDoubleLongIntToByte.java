 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleLongIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleLongIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongIntToByte constant(byte value) {
     ...
     */
    byte apply(double v1, long v2, int v3);
}
