 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionDoubleToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleToDouble constant(double value) {
        return (v1, v2) -> value;
    }
