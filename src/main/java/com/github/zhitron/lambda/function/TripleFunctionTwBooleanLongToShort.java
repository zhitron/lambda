 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwBooleanLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwBooleanLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanLongToShort constant(short value) {
     ...
     */
    short apply(boolean v1, boolean v2, long v3);
}
