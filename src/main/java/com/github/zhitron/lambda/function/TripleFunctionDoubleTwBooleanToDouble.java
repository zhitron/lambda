 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleTwBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleTwBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwBooleanToDouble constant(double value) {
     ...
     */
    double apply(double v1, boolean v2, boolean v3);
}
