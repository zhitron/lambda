 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongBooleanDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongBooleanDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanDoubleToInt constant(int value) {
     ...
     */
    int apply(long v1, boolean v2, double v3);
}
