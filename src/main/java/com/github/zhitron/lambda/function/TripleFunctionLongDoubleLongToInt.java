 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongDoubleLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongDoubleLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleLongToInt constant(int value) {
     ...
     */
    int apply(long v1, double v2, long v3);
}
