 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongIntLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongIntLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntLongToInt constant(int value) {
     ...
     */
    int apply(long v1, int v2, long v3);
}
