 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwIntLongBooleanToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, long v3, boolean v4);
}
