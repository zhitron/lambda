 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanToChar constant(char value) {
     ...
     */
    char apply(boolean v1, boolean v2, boolean v3);
}
