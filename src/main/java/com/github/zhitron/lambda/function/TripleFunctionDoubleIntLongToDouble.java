 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleIntLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleIntLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntLongToDouble constant(double value) {
     ...
     */
    double apply(double v1, int v2, long v3);
}
