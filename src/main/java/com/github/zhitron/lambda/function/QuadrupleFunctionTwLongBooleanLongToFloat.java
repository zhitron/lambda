 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanLongToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, boolean v3, long v4);
}
