 ...
 */
@FunctionalInterface
public interface TripleFunctionIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TripleFunctionIntToObject<?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <R> TripleFunctionIntToObject<R> empty() {
        return (TripleFunctionIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TripleFunctionIntToObject<R> constant(R value) {
