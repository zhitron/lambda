 ...
 */
@FunctionalInterface
public interface SingleFunctionDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    SingleFunctionDoubleToByte EMPTY = (v1) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static SingleFunctionDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionDoubleToByte constant(byte value) {
        return (v1) -> value;
    }
