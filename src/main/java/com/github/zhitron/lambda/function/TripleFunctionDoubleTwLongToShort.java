 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleTwLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleTwLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwLongToShort constant(short value) {
     ...
     */
    short apply(double v1, long v2, long v3);
}
