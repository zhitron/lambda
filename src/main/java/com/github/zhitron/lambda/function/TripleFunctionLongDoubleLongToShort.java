 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongDoubleLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongDoubleLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleLongToShort constant(short value) {
     ...
     */
    short apply(long v1, double v2, long v3);
}
