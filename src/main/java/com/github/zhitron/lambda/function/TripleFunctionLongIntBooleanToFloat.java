 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongIntBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongIntBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntBooleanToFloat constant(float value) {
     ...
     */
    float apply(long v1, int v2, boolean v3);
}
