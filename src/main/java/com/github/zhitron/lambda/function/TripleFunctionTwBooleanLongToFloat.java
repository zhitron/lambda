 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwBooleanLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwBooleanLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanLongToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, boolean v2, long v3);
}
