 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionLongDoubleToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionLongDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongDoubleToByte constant(byte value) {
        return (v1, v2) -> value;
    }
