 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntBooleanIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntBooleanIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanIntToDouble constant(double value) {
     ...
     */
    double apply(int v1, boolean v2, int v3);
}
