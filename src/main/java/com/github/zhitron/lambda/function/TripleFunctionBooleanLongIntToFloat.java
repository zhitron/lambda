 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanLongIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanLongIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongIntToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, long v2, int v3);
}
