 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntLongDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntLongDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongDoubleToFloat constant(float value) {
     ...
     */
    float apply(int v1, long v2, double v3);
}
