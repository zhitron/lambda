 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntDoubleLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionTwIntDoubleLongToChar EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToChar constant(char value) {
     ...
     */
    char apply(int v1, int v2, double v3, long v4);
}
