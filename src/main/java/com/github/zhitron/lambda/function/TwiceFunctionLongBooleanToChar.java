 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionLongBooleanToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionLongBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongBooleanToChar constant(char value) {
        return (v1, v2) -> value;
    }
