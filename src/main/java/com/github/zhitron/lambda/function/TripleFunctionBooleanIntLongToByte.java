 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanIntLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanIntLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntLongToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, int v2, long v3);
}
