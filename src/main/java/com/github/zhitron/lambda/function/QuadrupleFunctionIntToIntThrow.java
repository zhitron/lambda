 ...
 * 该接口扩展自 {@link QuadrupleFunctionIntToInt}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface QuadrupleFunctionIntToIntThrow<E extends Exception> extends QuadrupleFunctionIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionIntToIntThrow<?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
    ...
    static <E extends Exception> QuadrupleFunctionIntToIntThrow<E> empty() {
        return (QuadrupleFunctionIntToIntThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> QuadrupleFunctionIntToIntThrow<E> constant(int value) {
