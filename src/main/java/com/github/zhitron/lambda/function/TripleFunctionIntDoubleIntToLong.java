 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntDoubleIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntDoubleIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleIntToLong constant(long value) {
     ...
     */
    long apply(int v1, double v2, int v3);
}
