 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntBooleanLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntBooleanLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanLongToChar constant(char value) {
     ...
     */
    char apply(int v1, boolean v2, long v3);
}
