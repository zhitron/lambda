 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanLongBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanLongBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongBooleanToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, long v2, boolean v3);
}
