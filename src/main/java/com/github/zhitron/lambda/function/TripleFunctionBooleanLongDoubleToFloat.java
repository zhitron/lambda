 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanLongDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanLongDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongDoubleToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, long v2, double v3);
}
