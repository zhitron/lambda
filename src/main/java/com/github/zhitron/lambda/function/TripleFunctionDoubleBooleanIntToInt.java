 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleBooleanIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanIntToInt constant(int value) {
     ...
     */
    int apply(double v1, boolean v2, int v3);
}
