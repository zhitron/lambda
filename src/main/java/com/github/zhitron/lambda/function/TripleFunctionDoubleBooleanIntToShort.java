 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleBooleanIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanIntToShort constant(short value) {
     ...
     */
    short apply(double v1, boolean v2, int v3);
}
