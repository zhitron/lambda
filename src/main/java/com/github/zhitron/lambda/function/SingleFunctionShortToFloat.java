 ...
 */
@FunctionalInterface
public interface SingleFunctionShortToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    SingleFunctionShortToFloat EMPTY = (v1) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static SingleFunctionShortToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionShortToFloat constant(float value) {
        return (v1) -> value;
    }
