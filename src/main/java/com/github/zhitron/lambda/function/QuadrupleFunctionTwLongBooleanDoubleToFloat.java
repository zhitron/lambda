 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanDoubleToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanDoubleToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, boolean v3, double v4);
}
