 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionBooleanDoubleToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionBooleanDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanDoubleToShort constant(short value) {
        return (v1, v2) -> value;
    }
