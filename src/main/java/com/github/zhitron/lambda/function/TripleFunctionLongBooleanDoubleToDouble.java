 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongBooleanDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongBooleanDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanDoubleToDouble constant(double value) {
     ...
     */
    double apply(long v1, boolean v2, double v3);
}
