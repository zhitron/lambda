 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionBooleanToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanToChar constant(char value) {
        return (v1, v2) -> value;
    }
