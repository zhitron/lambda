 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleBooleanLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanLongToFloat constant(float value) {
     ...
     */
    float apply(double v1, boolean v2, long v3);
}
