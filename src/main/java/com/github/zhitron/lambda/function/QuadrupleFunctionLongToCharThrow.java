 ...
 * 该接口扩展自 {@link QuadrupleFunctionLongToChar}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface QuadrupleFunctionLongToCharThrow<E extends Exception> extends QuadrupleFunctionLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionLongToCharThrow<?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
    ...
    static <E extends Exception> QuadrupleFunctionLongToCharThrow<E> empty() {
        return (QuadrupleFunctionLongToCharThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> QuadrupleFunctionLongToCharThrow<E> constant(char value) {
     ...
     * @throws E 抛出执行过程中的异常
     */
    char applyThrow(long v1, long v2, long v3, long v4) throws E;
     ...
     */
    @Override
    default char apply(long v1, long v2, long v3, long v4) {
        try {
