 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongTwBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongTwBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwBooleanToLong constant(long value) {
     ...
     */
    long apply(long v1, boolean v2, boolean v3);
}
