 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanDoubleBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToShort constant(short value) {
     ...
     */
    short apply(boolean v1, double v2, boolean v3);
}
