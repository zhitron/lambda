 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleBooleanLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanLongToByte constant(byte value) {
     ...
     */
    byte apply(double v1, boolean v2, long v3);
}
