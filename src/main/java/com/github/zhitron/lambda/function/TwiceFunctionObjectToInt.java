 ...
 */
@FunctionalInterface
public interface TwiceFunctionObjectToInt<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionObjectToInt<?, ?> EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
    ...
    static <T, U> TwiceFunctionObjectToInt<T, U> empty() {
        return (TwiceFunctionObjectToInt<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TwiceFunctionObjectToInt<T, U> constant(int value) {
        return (v1, v2) -> value;
    }
