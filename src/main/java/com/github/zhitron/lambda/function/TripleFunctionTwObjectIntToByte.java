 ...
 */
@FunctionalInterface
public interface TripleFunctionTwObjectIntToByte<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwObjectIntToByte<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectIntToByte<T, U> empty() {
        return (TripleFunctionTwObjectIntToByte<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectIntToByte<T, U> constant(byte value) {
