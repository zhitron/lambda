 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleTwBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleTwBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwBooleanToLong constant(long value) {
     ...
     */
    long apply(double v1, boolean v2, boolean v3);
}
