 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwIntLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwIntLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntLongToDouble constant(double value) {
     ...
     */
    double apply(int v1, int v2, long v3);
}
