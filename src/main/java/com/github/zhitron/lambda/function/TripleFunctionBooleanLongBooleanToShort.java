 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanLongBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanLongBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongBooleanToShort constant(short value) {
     ...
     */
    short apply(boolean v1, long v2, boolean v3);
}
