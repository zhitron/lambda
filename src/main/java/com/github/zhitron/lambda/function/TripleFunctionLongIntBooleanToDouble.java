 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongIntBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongIntBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntBooleanToDouble constant(double value) {
     ...
     */
    double apply(long v1, int v2, boolean v3);
}
