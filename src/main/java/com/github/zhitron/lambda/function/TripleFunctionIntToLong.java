 ...
 */
@FunctionalInterface
public interface TripleFunctionIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntToLong constant(long value) {
     ...
     */
    long apply(int v1, int v2, int v3);
}
