 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanIntLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanIntLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntLongToChar constant(char value) {
     ...
     */
    char apply(boolean v1, int v2, long v3);
}
