 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwIntTwBooleanToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToInt constant(int value) {
     ...
     */
    int apply(int v1, int v2, boolean v3, boolean v4);
}
