 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanDoubleLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleLongToLong constant(long value) {
     ...
     */
    long apply(boolean v1, double v2, long v3);
}
