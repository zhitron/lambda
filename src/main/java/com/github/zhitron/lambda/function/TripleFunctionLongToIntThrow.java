 ...
 * 该接口扩展自 {@link TripleFunctionLongToInt}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface TripleFunctionLongToIntThrow<E extends Exception> extends TripleFunctionLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongToIntThrow<?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <E extends Exception> TripleFunctionLongToIntThrow<E> empty() {
        return (TripleFunctionLongToIntThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TripleFunctionLongToIntThrow<E> constant(int value) {
     ...
     * @throws E 抛出执行过程中的异常
     */
    int applyThrow(long v1, long v2, long v3) throws E;
     ...
     */
    @Override
    default int apply(long v1, long v2, long v3) {
        try {
