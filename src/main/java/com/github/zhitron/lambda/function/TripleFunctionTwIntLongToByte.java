 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwIntLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwIntLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntLongToByte constant(byte value) {
     ...
     */
    byte apply(int v1, int v2, long v3);
}
