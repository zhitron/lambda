 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleToLong constant(long value) {
     ...
     */
    long apply(double v1, double v2, double v3);
}
