 ...
 */
@FunctionalInterface
public interface SingleFunctionIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    SingleFunctionIntToShort EMPTY = (v1) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static SingleFunctionIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionIntToShort constant(short value) {
        return (v1) -> value;
    }
