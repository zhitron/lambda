 ...
 */
@FunctionalInterface
public interface SingleFunctionByteToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    SingleFunctionByteToShort EMPTY = (v1) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static SingleFunctionByteToShort empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionByteToShort constant(short value) {
        return (v1) -> value;
    }
