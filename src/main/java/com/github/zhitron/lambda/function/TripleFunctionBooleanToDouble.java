 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, boolean v2, boolean v3);
}
