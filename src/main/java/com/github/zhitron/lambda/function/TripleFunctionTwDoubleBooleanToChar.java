 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwDoubleBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwDoubleBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleBooleanToChar constant(char value) {
     ...
     */
    char apply(double v1, double v2, boolean v3);
}
