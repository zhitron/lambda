 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TripleFunctionLongTwIntToObject<?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <R> TripleFunctionLongTwIntToObject<R> empty() {
        return (TripleFunctionLongTwIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TripleFunctionLongTwIntToObject<R> constant(R value) {
