 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleIntBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleIntBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntBooleanToInt constant(int value) {
     ...
     */
    int apply(double v1, int v2, boolean v3);
}
