 ...
 * 该接口扩展自 {@link TripleFunctionIntToInt}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface TripleFunctionIntToIntThrow<E extends Exception> extends TripleFunctionIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntToIntThrow<?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <E extends Exception> TripleFunctionIntToIntThrow<E> empty() {
        return (TripleFunctionIntToIntThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TripleFunctionIntToIntThrow<E> constant(int value) {
