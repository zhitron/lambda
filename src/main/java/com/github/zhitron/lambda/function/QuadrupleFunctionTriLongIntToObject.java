 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTriLongIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    QuadrupleFunctionTriLongIntToObject<?> EMPTY = (v1, v2, v3, v4) -> null;
    ...
    static <R> QuadrupleFunctionTriLongIntToObject<R> empty() {
        return (QuadrupleFunctionTriLongIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> QuadrupleFunctionTriLongIntToObject<R> constant(R value) {
     ...
     */
    R apply(long v1, long v2, long v3, int v4);
}
