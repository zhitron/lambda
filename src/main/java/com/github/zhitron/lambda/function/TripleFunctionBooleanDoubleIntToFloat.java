 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanDoubleIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleIntToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, double v2, int v3);
}
