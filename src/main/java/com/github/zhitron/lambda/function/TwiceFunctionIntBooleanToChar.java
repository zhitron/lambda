 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionIntBooleanToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionIntBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntBooleanToChar constant(char value) {
        return (v1, v2) -> value;
    }
