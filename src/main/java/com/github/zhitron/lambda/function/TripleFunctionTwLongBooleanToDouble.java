 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwLongBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwLongBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongBooleanToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, boolean v3);
}
