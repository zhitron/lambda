 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanTwIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanTwIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwIntToChar constant(char value) {
     ...
     */
    char apply(boolean v1, int v2, int v3);
}
