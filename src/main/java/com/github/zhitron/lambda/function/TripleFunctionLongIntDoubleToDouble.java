 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongIntDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongIntDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntDoubleToDouble constant(double value) {
     ...
     */
    double apply(long v1, int v2, double v3);
}
