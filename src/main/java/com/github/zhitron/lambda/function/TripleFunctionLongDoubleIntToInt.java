 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongDoubleIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongDoubleIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleIntToInt constant(int value) {
     ...
     */
    int apply(long v1, double v2, int v3);
}
