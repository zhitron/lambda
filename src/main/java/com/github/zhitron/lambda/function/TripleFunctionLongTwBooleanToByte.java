 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongTwBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongTwBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwBooleanToByte constant(byte value) {
     ...
     */
    byte apply(long v1, boolean v2, boolean v3);
}
