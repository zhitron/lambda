 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionLongBooleanToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionLongBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongBooleanToFloat constant(float value) {
        return (v1, v2) -> value;
    }
