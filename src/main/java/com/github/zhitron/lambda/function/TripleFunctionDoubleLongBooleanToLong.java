 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleLongBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleLongBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongBooleanToLong constant(long value) {
     ...
     */
    long apply(double v1, long v2, boolean v3);
}
