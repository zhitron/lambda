 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionLongDoubleToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionLongDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongDoubleToInt constant(int value) {
        return (v1, v2) -> value;
    }
