 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionIntLongToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionIntLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntLongToFloat constant(float value) {
        return (v1, v2) -> value;
    }
