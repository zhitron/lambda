...
public interface TripleFunctionObjectLongBooleanToObjectThrow<T, R, E extends Exception> extends TripleFunctionObjectLongBooleanToObject<T, R> {
     ...
     */
    TripleFunctionObjectLongBooleanToObjectThrow<?, ?, ?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <T, R, E extends Exception> TripleFunctionObjectLongBooleanToObjectThrow<T, R, E> empty() {
        return (TripleFunctionObjectLongBooleanToObjectThrow<T, R, E>) EMPTY;
    }
     ...
     */
    static <T, R, E extends Exception> TripleFunctionObjectLongBooleanToObjectThrow<T, R, E> constant(R value) {
