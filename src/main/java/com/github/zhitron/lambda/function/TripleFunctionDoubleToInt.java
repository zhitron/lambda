 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleToInt constant(int value) {
     ...
     */
    int apply(double v1, double v2, double v3);
}
