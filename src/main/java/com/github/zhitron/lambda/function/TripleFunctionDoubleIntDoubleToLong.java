 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleIntDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleIntDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntDoubleToLong constant(long value) {
     ...
     */
    long apply(double v1, int v2, double v3);
}
