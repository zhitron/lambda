 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanIntToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanIntToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, boolean v3, int v4);
}
