 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleTwLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleTwLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwLongToChar constant(char value) {
     ...
     */
    char apply(double v1, long v2, long v3);
}
