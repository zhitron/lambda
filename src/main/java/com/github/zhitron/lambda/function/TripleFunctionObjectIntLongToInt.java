 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectIntLongToInt<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionObjectIntLongToInt<?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <T> TripleFunctionObjectIntLongToInt<T> empty() {
        return (TripleFunctionObjectIntLongToInt<T>) EMPTY;
    }
     ...
     */
    static <T> TripleFunctionObjectIntLongToInt<T> constant(int value) {
