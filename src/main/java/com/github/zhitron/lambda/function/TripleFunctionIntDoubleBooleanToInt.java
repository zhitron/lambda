 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntDoubleBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntDoubleBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleBooleanToInt constant(int value) {
     ...
     */
    int apply(int v1, double v2, boolean v3);
}
