 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwIntLongBooleanToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToLong constant(long value) {
     ...
     */
    long apply(int v1, int v2, long v3, boolean v4);
}
