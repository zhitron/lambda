 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongBooleanIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongBooleanIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanIntToFloat constant(float value) {
     ...
     */
    float apply(long v1, boolean v2, int v3);
}
