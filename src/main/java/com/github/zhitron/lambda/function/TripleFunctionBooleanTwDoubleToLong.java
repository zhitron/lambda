 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanTwDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanTwDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwDoubleToLong constant(long value) {
     ...
     */
    long apply(boolean v1, double v2, double v3);
}
