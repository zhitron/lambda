 ...
 */
@FunctionalInterface
public interface SingleFunctionByteToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    SingleFunctionByteToChar EMPTY = (v1) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static SingleFunctionByteToChar empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionByteToChar constant(char value) {
        return (v1) -> value;
    }
