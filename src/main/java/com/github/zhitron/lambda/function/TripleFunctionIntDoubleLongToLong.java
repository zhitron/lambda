 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntDoubleLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntDoubleLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleLongToLong constant(long value) {
     ...
     */
    long apply(int v1, double v2, long v3);
}
