 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionLongIntToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionLongIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongIntToInt constant(int value) {
        return (v1, v2) -> value;
    }
