 ...
 * 该接口扩展自 {@link TripleFunctionLongToLong}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface TripleFunctionLongToLongThrow<E extends Exception> extends TripleFunctionLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongToLongThrow<?> EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
    ...
    static <E extends Exception> TripleFunctionLongToLongThrow<E> empty() {
        return (TripleFunctionLongToLongThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TripleFunctionLongToLongThrow<E> constant(long value) {
