 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwLongIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwLongIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongIntToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, int v3);
}
