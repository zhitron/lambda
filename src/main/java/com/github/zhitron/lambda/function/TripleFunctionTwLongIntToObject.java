 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TripleFunctionTwLongIntToObject<?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <R> TripleFunctionTwLongIntToObject<R> empty() {
        return (TripleFunctionTwLongIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TripleFunctionTwLongIntToObject<R> constant(R value) {
     ...
     */
    R apply(long v1, long v2, int v3);
}
