 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanDoubleIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleIntToChar constant(char value) {
     ...
     */
    char apply(boolean v1, double v2, int v3);
}
