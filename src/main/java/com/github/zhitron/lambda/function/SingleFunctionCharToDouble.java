 ...
 */
@FunctionalInterface
public interface SingleFunctionCharToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    SingleFunctionCharToDouble EMPTY = (v1) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static SingleFunctionCharToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionCharToDouble constant(double value) {
        return (v1) -> value;
    }
