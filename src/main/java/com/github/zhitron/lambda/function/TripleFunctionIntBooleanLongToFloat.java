 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntBooleanLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntBooleanLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanLongToFloat constant(float value) {
     ...
     */
    float apply(int v1, boolean v2, long v3);
}
