 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntTwDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntTwDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwDoubleToChar constant(char value) {
     ...
     */
    char apply(int v1, double v2, double v3);
}
