 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwIntLongIntToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongIntToDouble constant(double value) {
     ...
     */
    double apply(int v1, int v2, long v3, int v4);
}
