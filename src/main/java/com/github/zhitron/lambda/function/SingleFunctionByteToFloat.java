 ...
 */
@FunctionalInterface
public interface SingleFunctionByteToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    SingleFunctionByteToFloat EMPTY = (v1) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static SingleFunctionByteToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionByteToFloat constant(float value) {
        return (v1) -> value;
    }
