...
public interface QuadrupleFunctionObjectBooleanIntLongToDouble<T> {
     ...
     */
    QuadrupleFunctionObjectBooleanIntLongToDouble<?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
    ...
    static <T> QuadrupleFunctionObjectBooleanIntLongToDouble<T> empty() {
        return (QuadrupleFunctionObjectBooleanIntLongToDouble<T>) EMPTY;
    }
     ...
     */
    static <T> QuadrupleFunctionObjectBooleanIntLongToDouble<T> constant(double value) {
