 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionDoubleBooleanToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionDoubleBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleBooleanToChar constant(char value) {
        return (v1, v2) -> value;
    }
