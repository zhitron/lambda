 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwIntLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwIntLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntLongToChar constant(char value) {
     ...
     */
    char apply(int v1, int v2, long v3);
}
