 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionIntDoubleToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionIntDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntDoubleToInt constant(int value) {
        return (v1, v2) -> value;
    }
