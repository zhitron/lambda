 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwBooleanDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwBooleanDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanDoubleToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, boolean v2, double v3);
}
