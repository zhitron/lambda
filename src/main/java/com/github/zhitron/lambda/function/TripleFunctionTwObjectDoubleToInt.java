 ...
 */
@FunctionalInterface
public interface TripleFunctionTwObjectDoubleToInt<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwObjectDoubleToInt<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectDoubleToInt<T, U> empty() {
        return (TripleFunctionTwObjectDoubleToInt<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectDoubleToInt<T, U> constant(int value) {
