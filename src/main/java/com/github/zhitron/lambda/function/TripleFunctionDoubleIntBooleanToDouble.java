 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleIntBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleIntBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntBooleanToDouble constant(double value) {
     ...
     */
    double apply(double v1, int v2, boolean v3);
}
