 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanDoubleBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToLong constant(long value) {
     ...
     */
    long apply(boolean v1, double v2, boolean v3);
}
