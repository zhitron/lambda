 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntTwBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntTwBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwBooleanToShort constant(short value) {
     ...
     */
    short apply(int v1, boolean v2, boolean v3);
}
