 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongDoubleBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongDoubleBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleBooleanToChar constant(char value) {
     ...
     */
    char apply(long v1, double v2, boolean v3);
}
