 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionDoubleToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleToLong constant(long value) {
        return (v1, v2) -> value;
    }
     ...
     */
    long apply(double v1, double v2);
}
