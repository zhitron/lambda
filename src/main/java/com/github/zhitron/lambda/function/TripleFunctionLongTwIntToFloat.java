 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongTwIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongTwIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwIntToFloat constant(float value) {
     ...
     */
    float apply(long v1, int v2, int v3);
}
