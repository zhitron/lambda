 ...
 */
@FunctionalInterface
public interface SingleFunctionBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    SingleFunctionBooleanToShort EMPTY = (v1) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static SingleFunctionBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionBooleanToShort constant(short value) {
        return (v1) -> value;
    }
