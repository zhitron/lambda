 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionLongIntToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionLongIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongIntToByte constant(byte value) {
        return (v1, v2) -> value;
    }
