 ...
 */
@FunctionalInterface
public interface SingleFunctionBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    SingleFunctionBooleanToDouble EMPTY = (v1) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static SingleFunctionBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionBooleanToDouble constant(double value) {
        return (v1) -> value;
    }
