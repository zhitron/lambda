 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanIntDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanIntDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntDoubleToChar constant(char value) {
     ...
     */
    char apply(boolean v1, int v2, double v3);
}
