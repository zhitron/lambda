 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionDoubleLongToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionDoubleLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleLongToByte constant(byte value) {
        return (v1, v2) -> value;
    }
