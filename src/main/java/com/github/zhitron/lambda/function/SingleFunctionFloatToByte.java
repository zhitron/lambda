 ...
 */
@FunctionalInterface
public interface SingleFunctionFloatToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    SingleFunctionFloatToByte EMPTY = (v1) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static SingleFunctionFloatToByte empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionFloatToByte constant(byte value) {
        return (v1) -> value;
    }
