...
public interface TripleFunctionTwIntBooleanToLongThrow<E extends Exception> extends TripleFunctionTwIntBooleanToLong {
     ...
     */
    TripleFunctionTwIntBooleanToLongThrow<?> EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
    ...
    static <E extends Exception> TripleFunctionTwIntBooleanToLongThrow<E> empty() {
        return (TripleFunctionTwIntBooleanToLongThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TripleFunctionTwIntBooleanToLongThrow<E> constant(long value) {
