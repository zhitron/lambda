 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntDoubleBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntDoubleBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleBooleanToShort constant(short value) {
     ...
     */
    short apply(int v1, double v2, boolean v3);
}
