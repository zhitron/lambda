 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwIntBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwIntBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntBooleanToChar constant(char value) {
     ...
     */
    char apply(int v1, int v2, boolean v3);
}
