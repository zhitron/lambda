 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwLongIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwLongIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongIntToShort constant(short value) {
     ...
     */
    short apply(long v1, long v2, int v3);
}
