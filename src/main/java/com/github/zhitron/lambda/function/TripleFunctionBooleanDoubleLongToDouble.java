 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanDoubleLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleLongToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, double v2, long v3);
}
