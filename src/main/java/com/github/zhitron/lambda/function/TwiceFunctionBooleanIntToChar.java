 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionBooleanIntToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionBooleanIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanIntToChar constant(char value) {
        return (v1, v2) -> value;
    }
