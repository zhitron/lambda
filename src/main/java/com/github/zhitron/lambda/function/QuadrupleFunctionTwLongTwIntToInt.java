 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwLongTwIntToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwIntToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, int v3, int v4);
}
