 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongBooleanDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongBooleanDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanDoubleToLong constant(long value) {
     ...
     */
    long apply(long v1, boolean v2, double v3);
}
