 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanDoubleBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, double v2, boolean v3);
}
