 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntLongToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionIntLongToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionIntLongToObject<R> empty() {
        return (TwiceFunctionIntLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionIntLongToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
