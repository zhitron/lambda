 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanLongDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanLongDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongDoubleToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, long v2, double v3);
}
