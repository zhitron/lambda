 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionBooleanDoubleToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionBooleanDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanDoubleToChar constant(char value) {
        return (v1, v2) -> value;
    }
