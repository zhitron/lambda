 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntTwLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntTwLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwLongToShort constant(short value) {
     ...
     */
    short apply(int v1, long v2, long v3);
}
