 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanDoubleLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleLongToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, double v2, long v3);
}
