 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongIntDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongIntDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntDoubleToByte constant(byte value) {
     ...
     */
    byte apply(long v1, int v2, double v3);
}
