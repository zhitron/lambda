 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanTwDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanTwDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwDoubleToShort constant(short value) {
     ...
     */
    short apply(boolean v1, double v2, double v3);
}
