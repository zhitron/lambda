 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntDoubleIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwIntDoubleIntToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntDoubleIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntDoubleIntToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, double v3, int v4);
}
