 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleTwLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleTwLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwLongToFloat constant(float value) {
     ...
     */
    float apply(double v1, long v2, long v3);
}
