 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongIntBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongIntBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntBooleanToLong constant(long value) {
     ...
     */
    long apply(long v1, int v2, boolean v3);
}
