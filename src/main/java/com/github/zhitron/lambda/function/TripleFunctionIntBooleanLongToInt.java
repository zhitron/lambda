 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntBooleanLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntBooleanLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanLongToInt constant(int value) {
     ...
     */
    int apply(int v1, boolean v2, long v3);
}
