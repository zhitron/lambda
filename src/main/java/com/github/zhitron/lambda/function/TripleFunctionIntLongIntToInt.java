 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntLongIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntLongIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongIntToInt constant(int value) {
     ...
     */
    int apply(int v1, long v2, int v3);
}
