 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntBooleanIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntBooleanIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanIntToLong constant(long value) {
     ...
     */
    long apply(int v1, boolean v2, int v3);
}
