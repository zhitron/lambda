 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongDoubleIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionTwLongDoubleIntToChar EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongDoubleIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongDoubleIntToChar constant(char value) {
     ...
     */
    char apply(long v1, long v2, double v3, int v4);
}
