 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleIntBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleIntBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntBooleanToFloat constant(float value) {
     ...
     */
    float apply(double v1, int v2, boolean v3);
}
