 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionDoubleIntToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionDoubleIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleIntToDouble constant(double value) {
        return (v1, v2) -> value;
    }
