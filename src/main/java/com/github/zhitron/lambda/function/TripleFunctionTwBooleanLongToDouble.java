 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwBooleanLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwBooleanLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanLongToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, boolean v2, long v3);
}
