 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntTwDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntTwDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwDoubleToByte constant(byte value) {
     ...
     */
    byte apply(int v1, double v2, double v3);
}
