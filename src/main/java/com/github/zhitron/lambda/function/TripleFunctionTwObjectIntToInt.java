...
public interface TripleFunctionTwObjectIntToInt<T, U> {
     ...
     */
    TripleFunctionTwObjectIntToInt<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectIntToInt<T, U> empty() {
        return (TripleFunctionTwObjectIntToInt<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectIntToInt<T, U> constant(int value) {
