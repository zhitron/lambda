 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionLongToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongToByte constant(byte value) {
        return (v1, v2) -> value;
    }
