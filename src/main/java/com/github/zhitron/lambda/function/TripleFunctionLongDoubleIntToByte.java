 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongDoubleIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongDoubleIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleIntToByte constant(byte value) {
     ...
     */
    byte apply(long v1, double v2, int v3);
}
