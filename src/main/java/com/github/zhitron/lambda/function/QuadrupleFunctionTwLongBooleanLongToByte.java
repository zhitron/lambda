 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanLongToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, boolean v3, long v4);
}
