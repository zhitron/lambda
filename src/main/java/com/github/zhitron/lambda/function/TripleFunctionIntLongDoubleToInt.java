 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntLongDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntLongDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongDoubleToInt constant(int value) {
     ...
     */
    int apply(int v1, long v2, double v3);
}
