 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntDoubleBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntDoubleBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleBooleanToFloat constant(float value) {
     ...
     */
    float apply(int v1, double v2, boolean v3);
}
