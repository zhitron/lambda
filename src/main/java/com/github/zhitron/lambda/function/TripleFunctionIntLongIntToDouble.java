 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntLongIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntLongIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongIntToDouble constant(double value) {
     ...
     */
    double apply(int v1, long v2, int v3);
}
