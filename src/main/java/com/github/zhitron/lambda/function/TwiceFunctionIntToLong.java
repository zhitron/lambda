 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionIntToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntToLong constant(long value) {
        return (v1, v2) -> value;
    }
