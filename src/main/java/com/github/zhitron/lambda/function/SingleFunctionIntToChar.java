 ...
 */
@FunctionalInterface
public interface SingleFunctionIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    SingleFunctionIntToChar EMPTY = (v1) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static SingleFunctionIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionIntToChar constant(char value) {
        return (v1) -> value;
    }
