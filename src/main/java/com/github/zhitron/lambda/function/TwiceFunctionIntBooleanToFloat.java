 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionIntBooleanToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionIntBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntBooleanToFloat constant(float value) {
        return (v1, v2) -> value;
    }
