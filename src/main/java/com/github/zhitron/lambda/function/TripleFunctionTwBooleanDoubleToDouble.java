 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwBooleanDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwBooleanDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanDoubleToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, boolean v2, double v3);
}
