 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectToDouble<T, U, V> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionObjectToDouble<?, ?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
    ...
    static <T, U, V> TripleFunctionObjectToDouble<T, U, V> empty() {
        return (TripleFunctionObjectToDouble<T, U, V>) EMPTY;
    }
     ...
     */
    static <T, U, V> TripleFunctionObjectToDouble<T, U, V> constant(double value) {
