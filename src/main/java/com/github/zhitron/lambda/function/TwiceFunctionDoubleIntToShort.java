 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionDoubleIntToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionDoubleIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleIntToShort constant(short value) {
        return (v1, v2) -> value;
    }
