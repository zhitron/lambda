 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, boolean v2, boolean v3);
}
