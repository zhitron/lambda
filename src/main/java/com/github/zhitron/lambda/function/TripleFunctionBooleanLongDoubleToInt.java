 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanLongDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanLongDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongDoubleToInt constant(int value) {
     ...
     */
    int apply(boolean v1, long v2, double v3);
}
