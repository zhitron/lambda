 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionDoubleIntToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionDoubleIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleIntToInt constant(int value) {
        return (v1, v2) -> value;
    }
