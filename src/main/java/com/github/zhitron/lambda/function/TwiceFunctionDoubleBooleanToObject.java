 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleBooleanToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionDoubleBooleanToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionDoubleBooleanToObject<R> empty() {
        return (TwiceFunctionDoubleBooleanToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionDoubleBooleanToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
