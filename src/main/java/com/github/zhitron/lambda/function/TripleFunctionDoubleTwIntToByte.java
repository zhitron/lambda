 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleTwIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleTwIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwIntToByte constant(byte value) {
     ...
     */
    byte apply(double v1, int v2, int v3);
}
