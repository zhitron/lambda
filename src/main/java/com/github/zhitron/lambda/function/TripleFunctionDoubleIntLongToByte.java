 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleIntLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleIntLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntLongToByte constant(byte value) {
     ...
     */
    byte apply(double v1, int v2, long v3);
}
