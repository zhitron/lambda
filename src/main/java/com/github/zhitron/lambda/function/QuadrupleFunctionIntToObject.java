 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    QuadrupleFunctionIntToObject<?> EMPTY = (v1, v2, v3, v4) -> null;
    ...
    static <R> QuadrupleFunctionIntToObject<R> empty() {
        return (QuadrupleFunctionIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> QuadrupleFunctionIntToObject<R> constant(R value) {
     ...
     */
    R apply(int v1, int v2, int v3, int v4);
}
