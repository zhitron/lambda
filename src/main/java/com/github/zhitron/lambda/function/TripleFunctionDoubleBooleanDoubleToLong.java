 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleBooleanDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToLong constant(long value) {
     ...
     */
    long apply(double v1, boolean v2, double v3);
}
