 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwBooleanLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwBooleanLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanLongToInt constant(int value) {
     ...
     */
    int apply(boolean v1, boolean v2, long v3);
}
