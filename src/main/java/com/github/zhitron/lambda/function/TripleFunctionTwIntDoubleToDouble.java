 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwIntDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwIntDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntDoubleToDouble constant(double value) {
     ...
     */
    double apply(int v1, int v2, double v3);
}
