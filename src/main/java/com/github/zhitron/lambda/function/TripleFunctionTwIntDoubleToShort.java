 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwIntDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwIntDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntDoubleToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, double v3);
}
