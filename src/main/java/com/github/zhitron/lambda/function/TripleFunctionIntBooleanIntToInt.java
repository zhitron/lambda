 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntBooleanIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntBooleanIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanIntToInt constant(int value) {
     ...
     */
    int apply(int v1, boolean v2, int v3);
}
