 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleToByte constant(byte value) {
     ...
     */
    byte apply(double v1, double v2, double v3);
}
