 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionIntBooleanToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionIntBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntBooleanToByte constant(byte value) {
        return (v1, v2) -> value;
    }
