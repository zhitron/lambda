 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongBooleanToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionLongBooleanToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionLongBooleanToObject<R> empty() {
        return (TwiceFunctionLongBooleanToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionLongBooleanToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
