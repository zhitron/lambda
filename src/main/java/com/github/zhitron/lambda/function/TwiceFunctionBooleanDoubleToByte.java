 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionBooleanDoubleToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionBooleanDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanDoubleToByte constant(byte value) {
        return (v1, v2) -> value;
    }
