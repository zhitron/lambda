 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntLongDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntLongDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongDoubleToChar constant(char value) {
     ...
     */
    char apply(int v1, long v2, double v3);
}
