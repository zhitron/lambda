 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwIntTwDoubleToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwDoubleToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, double v3, double v4);
}
