 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwDoubleBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwDoubleBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleBooleanToShort constant(short value) {
     ...
     */
    short apply(double v1, double v2, boolean v3);
}
