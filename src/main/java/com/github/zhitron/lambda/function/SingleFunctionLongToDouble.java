 ...
 */
@FunctionalInterface
public interface SingleFunctionLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    SingleFunctionLongToDouble EMPTY = (v1) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static SingleFunctionLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionLongToDouble constant(double value) {
        return (v1) -> value;
    }
