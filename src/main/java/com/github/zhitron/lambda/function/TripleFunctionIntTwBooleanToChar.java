 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntTwBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntTwBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwBooleanToChar constant(char value) {
     ...
     */
    char apply(int v1, boolean v2, boolean v3);
}
