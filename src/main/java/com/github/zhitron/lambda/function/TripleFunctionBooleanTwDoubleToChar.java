 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanTwDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanTwDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwDoubleToChar constant(char value) {
     ...
     */
    char apply(boolean v1, double v2, double v3);
}
