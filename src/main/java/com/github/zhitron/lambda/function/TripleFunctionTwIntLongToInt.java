 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwIntLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwIntLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntLongToInt constant(int value) {
     ...
     */
    int apply(int v1, int v2, long v3);
}
