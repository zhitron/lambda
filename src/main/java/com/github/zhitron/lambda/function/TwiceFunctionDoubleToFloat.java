 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionDoubleToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleToFloat constant(float value) {
        return (v1, v2) -> value;
    }
