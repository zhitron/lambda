 ...
 */
@FunctionalInterface
public interface SingleFunctionShortToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    SingleFunctionShortToChar EMPTY = (v1) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static SingleFunctionShortToChar empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionShortToChar constant(char value) {
        return (v1) -> value;
    }
