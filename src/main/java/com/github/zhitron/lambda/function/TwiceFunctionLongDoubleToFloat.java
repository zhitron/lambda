 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionLongDoubleToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionLongDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongDoubleToFloat constant(float value) {
        return (v1, v2) -> value;
    }
