 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleTwIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleTwIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwIntToChar constant(char value) {
     ...
     */
    char apply(double v1, int v2, int v3);
}
