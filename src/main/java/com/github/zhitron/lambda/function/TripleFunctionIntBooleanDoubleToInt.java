 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntBooleanDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntBooleanDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanDoubleToInt constant(int value) {
     ...
     */
    int apply(int v1, boolean v2, double v3);
}
