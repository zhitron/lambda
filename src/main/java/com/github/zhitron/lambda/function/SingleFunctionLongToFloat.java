 ...
 */
@FunctionalInterface
public interface SingleFunctionLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    SingleFunctionLongToFloat EMPTY = (v1) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static SingleFunctionLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionLongToFloat constant(float value) {
        return (v1) -> value;
    }
