 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwIntDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwIntDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntDoubleToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, double v3);
}
