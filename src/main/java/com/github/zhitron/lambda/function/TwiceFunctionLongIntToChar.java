 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionLongIntToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionLongIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongIntToChar constant(char value) {
        return (v1, v2) -> value;
    }
