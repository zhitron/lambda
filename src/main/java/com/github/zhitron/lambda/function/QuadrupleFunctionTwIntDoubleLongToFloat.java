 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntDoubleLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwIntDoubleLongToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, double v3, long v4);
}
