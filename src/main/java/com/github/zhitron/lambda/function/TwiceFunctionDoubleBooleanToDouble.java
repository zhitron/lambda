 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionDoubleBooleanToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionDoubleBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleBooleanToDouble constant(double value) {
        return (v1, v2) -> value;
    }
