 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectTwBooleanToInt<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionObjectTwBooleanToInt<?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <T> TripleFunctionObjectTwBooleanToInt<T> empty() {
        return (TripleFunctionObjectTwBooleanToInt<T>) EMPTY;
    }
     ...
     */
    static <T> TripleFunctionObjectTwBooleanToInt<T> constant(int value) {
     ...
     */
    int apply(T v1, boolean v2, boolean v3);
}
