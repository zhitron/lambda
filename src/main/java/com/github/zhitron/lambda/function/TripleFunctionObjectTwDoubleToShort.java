 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectTwDoubleToShort<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionObjectTwDoubleToShort<?> EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
    ...
    static <T> TripleFunctionObjectTwDoubleToShort<T> empty() {
        return (TripleFunctionObjectTwDoubleToShort<T>) EMPTY;
    }
     ...
     */
    static <T> TripleFunctionObjectTwDoubleToShort<T> constant(short value) {
     ...
     */
    short apply(T v1, double v2, double v3);
}
