 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleIntDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleIntDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntDoubleToChar constant(char value) {
     ...
     */
    char apply(double v1, int v2, double v3);
}
