 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleBooleanIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanIntToLong constant(long value) {
     ...
     */
    long apply(double v1, boolean v2, int v3);
}
