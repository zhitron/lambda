 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanLongBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanLongBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongBooleanToLong constant(long value) {
     ...
     */
    long apply(boolean v1, long v2, boolean v3);
}
