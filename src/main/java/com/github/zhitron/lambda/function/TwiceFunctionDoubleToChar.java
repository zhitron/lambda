 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionDoubleToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleToChar constant(char value) {
        return (v1, v2) -> value;
    }
