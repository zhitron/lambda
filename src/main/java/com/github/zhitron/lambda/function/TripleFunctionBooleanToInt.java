 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanToInt constant(int value) {
     ...
     */
    int apply(boolean v1, boolean v2, boolean v3);
}
