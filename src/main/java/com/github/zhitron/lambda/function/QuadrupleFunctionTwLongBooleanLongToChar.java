 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanLongToChar EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToChar constant(char value) {
     ...
     */
    char apply(long v1, long v2, boolean v3, long v4);
}
