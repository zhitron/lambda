 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntBooleanDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntBooleanDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanDoubleToByte constant(byte value) {
     ...
     */
    byte apply(int v1, boolean v2, double v3);
}
