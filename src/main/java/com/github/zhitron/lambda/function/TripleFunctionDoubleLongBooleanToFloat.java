 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleLongBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleLongBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongBooleanToFloat constant(float value) {
     ...
     */
    float apply(double v1, long v2, boolean v3);
}
