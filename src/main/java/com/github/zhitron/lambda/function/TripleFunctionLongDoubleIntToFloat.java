 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongDoubleIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongDoubleIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleIntToFloat constant(float value) {
     ...
     */
    float apply(long v1, double v2, int v3);
}
