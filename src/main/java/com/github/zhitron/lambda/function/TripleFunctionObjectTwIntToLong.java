 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectTwIntToLong<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionObjectTwIntToLong<?> EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
    ...
    static <T> TripleFunctionObjectTwIntToLong<T> empty() {
        return (TripleFunctionObjectTwIntToLong<T>) EMPTY;
    }
     ...
     */
    static <T> TripleFunctionObjectTwIntToLong<T> constant(long value) {
