 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionDoubleLongToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionDoubleLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleLongToFloat constant(float value) {
        return (v1, v2) -> value;
    }
