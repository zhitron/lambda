 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanLongIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanLongIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongIntToShort constant(short value) {
     ...
     */
    short apply(boolean v1, long v2, int v3);
}
