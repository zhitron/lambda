 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionLongIntToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionLongIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongIntToLong constant(long value) {
        return (v1, v2) -> value;
    }
