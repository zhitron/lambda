 ...
 */
@FunctionalInterface
public interface SingleFunctionShortToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    SingleFunctionShortToLong EMPTY = (v1) -> BasicConstant.LONG_ZERO;
     ...
     */
    static SingleFunctionShortToLong empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionShortToLong constant(long value) {
        return (v1) -> value;
    }
