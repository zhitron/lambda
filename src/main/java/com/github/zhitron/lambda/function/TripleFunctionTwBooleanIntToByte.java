 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwBooleanIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwBooleanIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanIntToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, boolean v2, int v3);
}
