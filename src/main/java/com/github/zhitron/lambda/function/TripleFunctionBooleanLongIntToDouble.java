 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanLongIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanLongIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongIntToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, long v2, int v3);
}
