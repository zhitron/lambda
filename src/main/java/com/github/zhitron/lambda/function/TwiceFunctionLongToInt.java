 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionLongToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongToInt constant(int value) {
        return (v1, v2) -> value;
    }
