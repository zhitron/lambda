 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanIntToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanIntToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, boolean v3, int v4);
}
