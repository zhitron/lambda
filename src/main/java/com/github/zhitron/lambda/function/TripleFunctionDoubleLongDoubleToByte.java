 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleLongDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleLongDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongDoubleToByte constant(byte value) {
     ...
     */
    byte apply(double v1, long v2, double v3);
}
