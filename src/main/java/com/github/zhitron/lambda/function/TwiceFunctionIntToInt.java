 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionIntToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntToInt constant(int value) {
        return (v1, v2) -> value;
    }
