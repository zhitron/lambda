 ...
 */
@FunctionalInterface
public interface SingleFunctionLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    SingleFunctionLongToChar EMPTY = (v1) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static SingleFunctionLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionLongToChar constant(char value) {
        return (v1) -> value;
    }
