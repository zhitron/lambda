 ...
 */
@FunctionalInterface
public interface SingleFunctionLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    SingleFunctionLongToShort EMPTY = (v1) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static SingleFunctionLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionLongToShort constant(short value) {
        return (v1) -> value;
    }
