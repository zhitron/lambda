 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntTwDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntTwDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwDoubleToDouble constant(double value) {
     ...
     */
    double apply(int v1, double v2, double v3);
}
