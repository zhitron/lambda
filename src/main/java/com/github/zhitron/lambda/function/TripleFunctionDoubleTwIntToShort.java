 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleTwIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleTwIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwIntToShort constant(short value) {
     ...
     */
    short apply(double v1, int v2, int v3);
}
