 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleBooleanIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanIntToChar constant(char value) {
     ...
     */
    char apply(double v1, boolean v2, int v3);
}
