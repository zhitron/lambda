 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanLongBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanLongBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongBooleanToInt constant(int value) {
     ...
     */
    int apply(boolean v1, long v2, boolean v3);
}
