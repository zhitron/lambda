 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntTwBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntTwBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwBooleanToInt constant(int value) {
     ...
     */
    int apply(int v1, boolean v2, boolean v3);
}
