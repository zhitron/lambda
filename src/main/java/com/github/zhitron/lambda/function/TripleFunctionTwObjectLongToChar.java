 ...
 */
@FunctionalInterface
public interface TripleFunctionTwObjectLongToChar<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwObjectLongToChar<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectLongToChar<T, U> empty() {
        return (TripleFunctionTwObjectLongToChar<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectLongToChar<T, U> constant(char value) {
