 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwBooleanLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwBooleanLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanLongToChar constant(char value) {
     ...
     */
    char apply(boolean v1, boolean v2, long v3);
}
