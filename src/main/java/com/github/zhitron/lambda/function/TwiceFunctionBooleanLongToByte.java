 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionBooleanLongToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionBooleanLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanLongToByte constant(byte value) {
        return (v1, v2) -> value;
    }
