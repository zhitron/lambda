 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwDoubleIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwDoubleIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleIntToLong constant(long value) {
     ...
     */
    long apply(double v1, double v2, int v3);
}
