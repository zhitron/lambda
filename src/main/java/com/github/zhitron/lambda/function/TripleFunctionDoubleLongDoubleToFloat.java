 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleLongDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleLongDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongDoubleToFloat constant(float value) {
     ...
     */
    float apply(double v1, long v2, double v3);
}
