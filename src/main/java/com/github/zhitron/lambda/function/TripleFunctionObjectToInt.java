 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectToInt<T, U, V> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionObjectToInt<?, ?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <T, U, V> TripleFunctionObjectToInt<T, U, V> empty() {
        return (TripleFunctionObjectToInt<T, U, V>) EMPTY;
    }
     ...
     */
    static <T, U, V> TripleFunctionObjectToInt<T, U, V> constant(int value) {
