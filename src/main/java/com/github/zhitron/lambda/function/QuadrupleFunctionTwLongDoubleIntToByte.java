 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongDoubleIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwLongDoubleIntToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongDoubleIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongDoubleIntToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, double v3, int v4);
}
