 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntLongBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntLongBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongBooleanToFloat constant(float value) {
     ...
     */
    float apply(int v1, long v2, boolean v3);
}
