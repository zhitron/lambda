 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionIntDoubleToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionIntDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntDoubleToChar constant(char value) {
        return (v1, v2) -> value;
    }
