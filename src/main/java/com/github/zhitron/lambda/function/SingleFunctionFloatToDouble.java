 ...
 */
@FunctionalInterface
public interface SingleFunctionFloatToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    SingleFunctionFloatToDouble EMPTY = (v1) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static SingleFunctionFloatToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionFloatToDouble constant(double value) {
        return (v1) -> value;
    }
