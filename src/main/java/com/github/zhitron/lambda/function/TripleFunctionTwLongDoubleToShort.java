 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwLongDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwLongDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongDoubleToShort constant(short value) {
     ...
     */
    short apply(long v1, long v2, double v3);
}
