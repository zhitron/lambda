 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionIntBooleanToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionIntBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntBooleanToDouble constant(double value) {
        return (v1, v2) -> value;
    }
