 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleLongDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleLongDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongDoubleToLong constant(long value) {
     ...
     */
    long apply(double v1, long v2, double v3);
}
