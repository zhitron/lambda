 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleIntDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleIntDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntDoubleToFloat constant(float value) {
     ...
     */
    float apply(double v1, int v2, double v3);
}
