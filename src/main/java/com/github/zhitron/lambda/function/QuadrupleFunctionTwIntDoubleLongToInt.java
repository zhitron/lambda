 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntDoubleLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwIntDoubleLongToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToInt constant(int value) {
     ...
     */
    int apply(int v1, int v2, double v3, long v4);
}
