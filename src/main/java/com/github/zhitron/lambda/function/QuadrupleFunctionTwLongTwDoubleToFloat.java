 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwLongTwDoubleToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwDoubleToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, double v3, double v4);
}
