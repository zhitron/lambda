 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwIntLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwIntLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntLongToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, long v3);
}
