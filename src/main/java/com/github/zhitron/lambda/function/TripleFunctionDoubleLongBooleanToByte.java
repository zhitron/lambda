 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleLongBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleLongBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongBooleanToByte constant(byte value) {
     ...
     */
    byte apply(double v1, long v2, boolean v3);
}
