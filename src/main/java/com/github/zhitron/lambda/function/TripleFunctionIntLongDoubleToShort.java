 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntLongDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntLongDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongDoubleToShort constant(short value) {
     ...
     */
    short apply(int v1, long v2, double v3);
}
