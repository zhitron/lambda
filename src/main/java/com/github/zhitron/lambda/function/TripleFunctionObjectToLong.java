 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectToLong<T, U, V> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionObjectToLong<?, ?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
    ...
    static <T, U, V> TripleFunctionObjectToLong<T, U, V> empty() {
        return (TripleFunctionObjectToLong<T, U, V>) EMPTY;
    }
     ...
     */
    static <T, U, V> TripleFunctionObjectToLong<T, U, V> constant(long value) {
