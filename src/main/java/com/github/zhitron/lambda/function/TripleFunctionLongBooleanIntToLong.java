 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongBooleanIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongBooleanIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanIntToLong constant(long value) {
     ...
     */
    long apply(long v1, boolean v2, int v3);
}
