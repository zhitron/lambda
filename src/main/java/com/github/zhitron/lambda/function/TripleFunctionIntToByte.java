 ...
 */
@FunctionalInterface
public interface TripleFunctionIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntToByte constant(byte value) {
     ...
     */
    byte apply(int v1, int v2, int v3);
}
