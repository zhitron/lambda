...
public interface TwiceFunctionBooleanToByte {
     ...
     */
    TwiceFunctionBooleanToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanToByte constant(byte value) {
        return (v1, v2) -> value;
    }
