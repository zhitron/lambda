 ...
 */
@FunctionalInterface
public interface SingleFunctionBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    SingleFunctionBooleanToChar EMPTY = (v1) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static SingleFunctionBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionBooleanToChar constant(char value) {
        return (v1) -> value;
    }
