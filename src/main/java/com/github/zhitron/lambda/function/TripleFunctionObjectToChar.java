 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectToChar<T, U, V> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionObjectToChar<?, ?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
    ...
    static <T, U, V> TripleFunctionObjectToChar<T, U, V> empty() {
        return (TripleFunctionObjectToChar<T, U, V>) EMPTY;
    }
     ...
     */
    static <T, U, V> TripleFunctionObjectToChar<T, U, V> constant(char value) {
