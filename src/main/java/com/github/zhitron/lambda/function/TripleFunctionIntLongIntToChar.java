 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntLongIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntLongIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongIntToChar constant(char value) {
     ...
     */
    char apply(int v1, long v2, int v3);
}
