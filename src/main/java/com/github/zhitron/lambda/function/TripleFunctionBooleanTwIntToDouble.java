 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanTwIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanTwIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwIntToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, int v2, int v3);
}
