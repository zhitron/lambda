 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntTwDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntTwDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwDoubleToFloat constant(float value) {
     ...
     */
    float apply(int v1, double v2, double v3);
}
