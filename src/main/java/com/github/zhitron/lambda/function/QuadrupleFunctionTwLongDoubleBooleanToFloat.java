 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongDoubleBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwLongDoubleBooleanToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongDoubleBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongDoubleBooleanToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, double v3, boolean v4);
}
