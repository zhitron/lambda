 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwIntTwLongToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwLongToDouble constant(double value) {
     ...
     */
    double apply(int v1, int v2, long v3, long v4);
}
