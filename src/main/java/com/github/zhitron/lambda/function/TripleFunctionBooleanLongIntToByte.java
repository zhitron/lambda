 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanLongIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanLongIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongIntToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, long v2, int v3);
}
