 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanTwIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanTwIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwIntToInt constant(int value) {
     ...
     */
    int apply(boolean v1, int v2, int v3);
}
