 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongDoubleIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwLongDoubleIntToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongDoubleIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongDoubleIntToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, double v3, int v4);
}
