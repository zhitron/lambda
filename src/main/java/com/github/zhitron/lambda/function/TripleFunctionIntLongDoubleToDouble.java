 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntLongDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntLongDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongDoubleToDouble constant(double value) {
     ...
     */
    double apply(int v1, long v2, double v3);
}
