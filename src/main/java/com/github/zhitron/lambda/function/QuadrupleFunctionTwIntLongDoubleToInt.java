 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwIntLongDoubleToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToInt constant(int value) {
     ...
     */
    int apply(int v1, int v2, long v3, double v4);
}
