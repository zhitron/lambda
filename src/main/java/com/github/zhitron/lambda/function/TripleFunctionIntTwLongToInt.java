 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntTwLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntTwLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwLongToInt constant(int value) {
     ...
     */
    int apply(int v1, long v2, long v3);
}
