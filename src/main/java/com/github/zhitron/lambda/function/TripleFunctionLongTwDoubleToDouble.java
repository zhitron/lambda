 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongTwDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongTwDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwDoubleToDouble constant(double value) {
     ...
     */
    double apply(long v1, double v2, double v3);
}
