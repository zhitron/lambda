 ...
 */
@FunctionalInterface
public interface TwiceFunctionObjectToByte<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionObjectToByte<?, ?> EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
    ...
    static <T, U> TwiceFunctionObjectToByte<T, U> empty() {
        return (TwiceFunctionObjectToByte<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TwiceFunctionObjectToByte<T, U> constant(byte value) {
        return (v1, v2) -> value;
    }
