 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwIntDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwIntDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntDoubleToChar constant(char value) {
     ...
     */
    char apply(int v1, int v2, double v3);
}
