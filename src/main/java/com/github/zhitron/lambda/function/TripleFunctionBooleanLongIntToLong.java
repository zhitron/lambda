 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanLongIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanLongIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongIntToLong constant(long value) {
     ...
     */
    long apply(boolean v1, long v2, int v3);
}
