 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwBooleanDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwBooleanDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanDoubleToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, boolean v2, double v3);
}
