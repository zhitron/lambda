 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwLongBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwLongBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongBooleanToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, boolean v3);
}
