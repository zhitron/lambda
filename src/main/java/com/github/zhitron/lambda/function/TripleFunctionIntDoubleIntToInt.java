 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntDoubleIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntDoubleIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleIntToInt constant(int value) {
     ...
     */
    int apply(int v1, double v2, int v3);
}
