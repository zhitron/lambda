 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntDoubleBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntDoubleBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleBooleanToDouble constant(double value) {
     ...
     */
    double apply(int v1, double v2, boolean v3);
}
