 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectTwIntToChar<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionObjectTwIntToChar<?> EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
    ...
    static <T> TripleFunctionObjectTwIntToChar<T> empty() {
        return (TripleFunctionObjectTwIntToChar<T>) EMPTY;
    }
     ...
     */
    static <T> TripleFunctionObjectTwIntToChar<T> constant(char value) {
