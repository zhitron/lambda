 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionDoubleLongToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionDoubleLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleLongToInt constant(int value) {
        return (v1, v2) -> value;
    }
