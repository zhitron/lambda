 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionBooleanIntToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionBooleanIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanIntToFloat constant(float value) {
        return (v1, v2) -> value;
    }
