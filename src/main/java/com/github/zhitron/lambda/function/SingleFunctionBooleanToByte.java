 ...
 */
@FunctionalInterface
public interface SingleFunctionBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    SingleFunctionBooleanToByte EMPTY = (v1) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static SingleFunctionBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionBooleanToByte constant(byte value) {
        return (v1) -> value;
    }
