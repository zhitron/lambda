 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongDoubleIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwLongDoubleIntToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongDoubleIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongDoubleIntToLong constant(long value) {
     ...
     */
    long apply(long v1, long v2, double v3, int v4);
}
