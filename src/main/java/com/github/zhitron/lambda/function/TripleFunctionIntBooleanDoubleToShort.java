 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntBooleanDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntBooleanDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanDoubleToShort constant(short value) {
     ...
     */
    short apply(int v1, boolean v2, double v3);
}
