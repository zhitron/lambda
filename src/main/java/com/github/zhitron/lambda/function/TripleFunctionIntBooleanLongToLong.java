 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntBooleanLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntBooleanLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanLongToLong constant(long value) {
     ...
     */
    long apply(int v1, boolean v2, long v3);
}
