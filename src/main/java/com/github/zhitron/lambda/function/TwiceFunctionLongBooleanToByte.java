 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionLongBooleanToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionLongBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongBooleanToByte constant(byte value) {
        return (v1, v2) -> value;
    }
