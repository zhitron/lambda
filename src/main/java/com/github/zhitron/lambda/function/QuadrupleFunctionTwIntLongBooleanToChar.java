 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionTwIntLongBooleanToChar EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToChar constant(char value) {
     ...
     */
    char apply(int v1, int v2, long v3, boolean v4);
}
