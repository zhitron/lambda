 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanLongDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanLongDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongDoubleToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, long v2, double v3);
}
