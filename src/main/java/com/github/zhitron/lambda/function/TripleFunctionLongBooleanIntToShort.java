 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongBooleanIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongBooleanIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanIntToShort constant(short value) {
     ...
     */
    short apply(long v1, boolean v2, int v3);
}
