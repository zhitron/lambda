 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectToShort<T, U, V> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionObjectToShort<?, ?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
    ...
    static <T, U, V> TripleFunctionObjectToShort<T, U, V> empty() {
        return (TripleFunctionObjectToShort<T, U, V>) EMPTY;
    }
     ...
     */
    static <T, U, V> TripleFunctionObjectToShort<T, U, V> constant(short value) {
