 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwLongIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwLongIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongIntToChar constant(char value) {
     ...
     */
    char apply(long v1, long v2, int v3);
}
