 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwLongIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwLongIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongIntToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, int v3);
}
