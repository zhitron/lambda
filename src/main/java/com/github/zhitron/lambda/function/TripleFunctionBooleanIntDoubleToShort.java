 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanIntDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanIntDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntDoubleToShort constant(short value) {
     ...
     */
    short apply(boolean v1, int v2, double v3);
}
