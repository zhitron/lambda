 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwLongIntBooleanToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntBooleanToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, int v3, boolean v4);
}
