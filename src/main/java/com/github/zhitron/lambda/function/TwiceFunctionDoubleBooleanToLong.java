 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionDoubleBooleanToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionDoubleBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleBooleanToLong constant(long value) {
        return (v1, v2) -> value;
    }
