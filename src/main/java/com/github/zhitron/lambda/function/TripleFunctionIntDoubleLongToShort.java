 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntDoubleLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntDoubleLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleLongToShort constant(short value) {
     ...
     */
    short apply(int v1, double v2, long v3);
}
