 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanToLong constant(long value) {
     ...
     */
    long apply(boolean v1, boolean v2, boolean v3);
}
