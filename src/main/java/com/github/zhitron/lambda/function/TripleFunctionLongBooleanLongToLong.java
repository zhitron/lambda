 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongBooleanLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongBooleanLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanLongToLong constant(long value) {
     ...
     */
    long apply(long v1, boolean v2, long v3);
}
