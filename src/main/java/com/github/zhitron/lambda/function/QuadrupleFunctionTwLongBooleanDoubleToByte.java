 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanDoubleToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanDoubleToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, boolean v3, double v4);
}
