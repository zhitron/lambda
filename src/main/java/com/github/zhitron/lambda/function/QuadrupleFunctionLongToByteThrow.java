 ...
 * 该接口扩展自 {@link QuadrupleFunctionLongToByte}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface QuadrupleFunctionLongToByteThrow<E extends Exception> extends QuadrupleFunctionLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionLongToByteThrow<?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
    ...
    static <E extends Exception> QuadrupleFunctionLongToByteThrow<E> empty() {
        return (QuadrupleFunctionLongToByteThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> QuadrupleFunctionLongToByteThrow<E> constant(byte value) {
     ...
     * @throws E 抛出执行过程中的异常
     */
    byte applyThrow(long v1, long v2, long v3, long v4) throws E;
     ...
     */
    @Override
    default byte apply(long v1, long v2, long v3, long v4) {
        try {
