 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwLongTwIntToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwIntToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, int v3, int v4);
}
