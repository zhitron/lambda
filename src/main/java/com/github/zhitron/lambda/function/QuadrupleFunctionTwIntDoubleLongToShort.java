 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntDoubleLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwIntDoubleLongToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, double v3, long v4);
}
