 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongIntLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongIntLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntLongToLong constant(long value) {
     ...
     */
    long apply(long v1, int v2, long v3);
}
