 ...
 */
@FunctionalInterface
public interface TripleFunctionLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongToShort constant(short value) {
     ...
     */
    short apply(long v1, long v2, long v3);
}
