 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongBooleanDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongBooleanDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanDoubleToShort constant(short value) {
     ...
     */
    short apply(long v1, boolean v2, double v3);
}
