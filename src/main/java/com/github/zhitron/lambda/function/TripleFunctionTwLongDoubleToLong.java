 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwLongDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwLongDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongDoubleToLong constant(long value) {
     ...
     */
    long apply(long v1, long v2, double v3);
}
