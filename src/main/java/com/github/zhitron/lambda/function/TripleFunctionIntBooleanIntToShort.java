 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntBooleanIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntBooleanIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanIntToShort constant(short value) {
     ...
     */
    short apply(int v1, boolean v2, int v3);
}
