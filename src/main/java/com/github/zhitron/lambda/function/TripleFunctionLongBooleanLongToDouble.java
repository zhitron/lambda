 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongBooleanLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongBooleanLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanLongToDouble constant(double value) {
     ...
     */
    double apply(long v1, boolean v2, long v3);
}
