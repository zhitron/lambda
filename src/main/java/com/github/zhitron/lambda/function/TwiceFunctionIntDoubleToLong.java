 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionIntDoubleToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionIntDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntDoubleToLong constant(long value) {
        return (v1, v2) -> value;
    }
