 ...
 */
@FunctionalInterface
public interface SingleFunctionDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    SingleFunctionDoubleToShort EMPTY = (v1) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static SingleFunctionDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionDoubleToShort constant(short value) {
        return (v1) -> value;
    }
