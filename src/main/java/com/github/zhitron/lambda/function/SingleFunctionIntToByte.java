 ...
 */
@FunctionalInterface
public interface SingleFunctionIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    SingleFunctionIntToByte EMPTY = (v1) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static SingleFunctionIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionIntToByte constant(byte value) {
        return (v1) -> value;
    }
