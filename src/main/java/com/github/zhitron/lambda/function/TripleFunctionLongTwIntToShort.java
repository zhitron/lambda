 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongTwIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongTwIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwIntToShort constant(short value) {
     ...
     */
    short apply(long v1, int v2, int v3);
}
