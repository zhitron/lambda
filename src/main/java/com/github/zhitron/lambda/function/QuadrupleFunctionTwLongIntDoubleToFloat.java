 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwLongIntDoubleToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntDoubleToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, int v3, double v4);
}
