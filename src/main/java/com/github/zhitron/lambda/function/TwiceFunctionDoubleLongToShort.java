 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionDoubleLongToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionDoubleLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleLongToShort constant(short value) {
        return (v1, v2) -> value;
    }
