 ...
 */
@FunctionalInterface
public interface SingleFunctionDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    SingleFunctionDoubleToLong EMPTY = (v1) -> BasicConstant.LONG_ZERO;
     ...
     */
    static SingleFunctionDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionDoubleToLong constant(long value) {
        return (v1) -> value;
    }
