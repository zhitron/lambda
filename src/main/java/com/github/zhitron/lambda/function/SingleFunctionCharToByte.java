 ...
 */
@FunctionalInterface
public interface SingleFunctionCharToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    SingleFunctionCharToByte EMPTY = (v1) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static SingleFunctionCharToByte empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionCharToByte constant(byte value) {
        return (v1) -> value;
    }
