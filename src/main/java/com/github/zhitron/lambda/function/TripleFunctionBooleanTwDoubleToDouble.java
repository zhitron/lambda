 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanTwDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanTwDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwDoubleToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, double v2, double v3);
}
