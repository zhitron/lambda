 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleBooleanDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToByte constant(byte value) {
     ...
     */
    byte apply(double v1, boolean v2, double v3);
}
