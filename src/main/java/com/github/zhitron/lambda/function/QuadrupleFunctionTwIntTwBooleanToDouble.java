 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwIntTwBooleanToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToDouble constant(double value) {
     ...
     */
    double apply(int v1, int v2, boolean v3, boolean v4);
}
