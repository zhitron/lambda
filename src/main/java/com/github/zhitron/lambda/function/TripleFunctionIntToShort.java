 ...
 */
@FunctionalInterface
public interface TripleFunctionIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, int v3);
}
