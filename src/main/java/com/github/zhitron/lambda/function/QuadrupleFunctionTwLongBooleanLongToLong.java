 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanLongToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToLong constant(long value) {
     ...
     */
    long apply(long v1, long v2, boolean v3, long v4);
}
