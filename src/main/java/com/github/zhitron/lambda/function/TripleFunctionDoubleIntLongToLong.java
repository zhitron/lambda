 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleIntLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleIntLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntLongToLong constant(long value) {
     ...
     */
    long apply(double v1, int v2, long v3);
}
