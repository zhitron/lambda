 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionIntToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntToChar constant(char value) {
        return (v1, v2) -> value;
    }
