 ...
 */
@FunctionalInterface
public interface SingleFunctionCharToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    SingleFunctionCharToLong EMPTY = (v1) -> BasicConstant.LONG_ZERO;
     ...
     */
    static SingleFunctionCharToLong empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionCharToLong constant(long value) {
        return (v1) -> value;
    }
