 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionIntDoubleToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionIntDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntDoubleToShort constant(short value) {
        return (v1, v2) -> value;
    }
