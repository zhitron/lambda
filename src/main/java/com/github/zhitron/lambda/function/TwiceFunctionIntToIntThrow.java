 ...
 * 该接口扩展自 {@link TwiceFunctionIntToInt}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface TwiceFunctionIntToIntThrow<E extends Exception> extends TwiceFunctionIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionIntToIntThrow<?> EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
    ...
    static <E extends Exception> TwiceFunctionIntToIntThrow<E> empty() {
        return (TwiceFunctionIntToIntThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TwiceFunctionIntToIntThrow<E> constant(int value) {
        return (v1, v2) -> value;
    }
