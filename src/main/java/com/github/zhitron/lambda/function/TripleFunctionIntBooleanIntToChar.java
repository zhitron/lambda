 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntBooleanIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntBooleanIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanIntToChar constant(char value) {
     ...
     */
    char apply(int v1, boolean v2, int v3);
}
