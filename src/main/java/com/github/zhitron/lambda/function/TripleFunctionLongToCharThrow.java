 ...
 * 该接口扩展自 {@link TripleFunctionLongToChar}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface TripleFunctionLongToCharThrow<E extends Exception> extends TripleFunctionLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongToCharThrow<?> EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
    ...
    static <E extends Exception> TripleFunctionLongToCharThrow<E> empty() {
        return (TripleFunctionLongToCharThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TripleFunctionLongToCharThrow<E> constant(char value) {
     ...
     * @throws E 抛出执行过程中的异常
     */
    char applyThrow(long v1, long v2, long v3) throws E;
     ...
     */
    @Override
    default char apply(long v1, long v2, long v3) {
        try {
