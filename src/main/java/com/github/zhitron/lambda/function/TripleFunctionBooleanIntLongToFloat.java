 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanIntLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanIntLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntLongToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, int v2, long v3);
}
