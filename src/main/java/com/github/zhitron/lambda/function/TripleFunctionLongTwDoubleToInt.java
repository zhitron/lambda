 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongTwDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongTwDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwDoubleToInt constant(int value) {
     ...
     */
    int apply(long v1, double v2, double v3);
}
