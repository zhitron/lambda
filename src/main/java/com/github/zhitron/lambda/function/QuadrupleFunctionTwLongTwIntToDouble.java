 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwLongTwIntToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwIntToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, int v3, int v4);
}
