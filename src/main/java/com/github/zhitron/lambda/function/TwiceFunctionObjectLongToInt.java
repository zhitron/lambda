 ...
 */
@FunctionalInterface
public interface TwiceFunctionObjectLongToInt<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionObjectLongToInt<?> EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
    ...
    static <T> TwiceFunctionObjectLongToInt<T> empty() {
        return (TwiceFunctionObjectLongToInt<T>) EMPTY;
    }
     ...
     */
    static <T> TwiceFunctionObjectLongToInt<T> constant(int value) {
        return (v1, v2) -> value;
    }
