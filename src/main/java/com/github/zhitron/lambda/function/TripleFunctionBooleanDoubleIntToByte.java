 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanDoubleIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleIntToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, double v2, int v3);
}
