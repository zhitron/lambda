 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongDoubleBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwLongDoubleBooleanToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongDoubleBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongDoubleBooleanToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, double v3, boolean v4);
}
