 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleIntDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleIntDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntDoubleToShort constant(short value) {
     ...
     */
    short apply(double v1, int v2, double v3);
}
