 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleIntDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleIntDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntDoubleToDouble constant(double value) {
     ...
     */
    double apply(double v1, int v2, double v3);
}
