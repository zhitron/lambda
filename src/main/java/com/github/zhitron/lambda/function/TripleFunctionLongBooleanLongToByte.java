 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongBooleanLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongBooleanLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanLongToByte constant(byte value) {
     ...
     */
    byte apply(long v1, boolean v2, long v3);
}
