 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntTwDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntTwDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwDoubleToLong constant(long value) {
     ...
     */
    long apply(int v1, double v2, double v3);
}
