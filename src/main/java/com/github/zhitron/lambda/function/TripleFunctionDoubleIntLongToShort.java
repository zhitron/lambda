 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleIntLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleIntLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntLongToShort constant(short value) {
     ...
     */
    short apply(double v1, int v2, long v3);
}
