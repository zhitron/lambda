 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    QuadrupleFunctionTwLongIntBooleanToDouble EMPTY = (v1, v2, v3, v4) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntBooleanToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, int v3, boolean v4);
}
