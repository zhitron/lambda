 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleTwBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleTwBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwBooleanToFloat constant(float value) {
     ...
     */
    float apply(double v1, boolean v2, boolean v3);
}
