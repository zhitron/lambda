 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntDoubleLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwIntDoubleLongToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntDoubleLongToByte constant(byte value) {
     ...
     */
    byte apply(int v1, int v2, double v3, long v4);
}
