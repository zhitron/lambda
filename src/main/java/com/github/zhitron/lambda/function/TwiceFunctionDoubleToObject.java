 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionDoubleToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionDoubleToObject<R> empty() {
        return (TwiceFunctionDoubleToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionDoubleToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
