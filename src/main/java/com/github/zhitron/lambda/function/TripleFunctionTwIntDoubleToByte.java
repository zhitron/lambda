 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwIntDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwIntDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntDoubleToByte constant(byte value) {
     ...
     */
    byte apply(int v1, int v2, double v3);
}
