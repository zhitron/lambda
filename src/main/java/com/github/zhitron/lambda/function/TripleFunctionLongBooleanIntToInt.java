 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongBooleanIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongBooleanIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanIntToInt constant(int value) {
     ...
     */
    int apply(long v1, boolean v2, int v3);
}
