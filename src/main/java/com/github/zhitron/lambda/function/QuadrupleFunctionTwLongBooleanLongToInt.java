 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanLongToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanLongToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, boolean v3, long v4);
}
