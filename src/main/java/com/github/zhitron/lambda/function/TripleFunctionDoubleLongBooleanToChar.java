 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleLongBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleLongBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongBooleanToChar constant(char value) {
     ...
     */
    char apply(double v1, long v2, boolean v3);
}
