 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntTwDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntTwDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwDoubleToInt constant(int value) {
     ...
     */
    int apply(int v1, double v2, double v3);
}
