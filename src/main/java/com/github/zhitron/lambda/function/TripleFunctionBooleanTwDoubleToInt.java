 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanTwDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanTwDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwDoubleToInt constant(int value) {
     ...
     */
    int apply(boolean v1, double v2, double v3);
}
