 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionBooleanToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanToInt constant(int value) {
        return (v1, v2) -> value;
    }
