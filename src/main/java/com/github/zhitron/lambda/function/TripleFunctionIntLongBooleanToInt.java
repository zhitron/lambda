 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntLongBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntLongBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongBooleanToInt constant(int value) {
     ...
     */
    int apply(int v1, long v2, boolean v3);
}
