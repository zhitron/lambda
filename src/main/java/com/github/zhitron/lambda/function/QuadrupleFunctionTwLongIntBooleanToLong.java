 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwLongIntBooleanToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntBooleanToLong constant(long value) {
     ...
     */
    long apply(long v1, long v2, int v3, boolean v4);
}
