 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionDoubleLongToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionDoubleLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleLongToChar constant(char value) {
        return (v1, v2) -> value;
    }
