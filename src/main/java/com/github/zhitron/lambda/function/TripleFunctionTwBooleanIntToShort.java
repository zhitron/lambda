 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwBooleanIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwBooleanIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanIntToShort constant(short value) {
     ...
     */
    short apply(boolean v1, boolean v2, int v3);
}
