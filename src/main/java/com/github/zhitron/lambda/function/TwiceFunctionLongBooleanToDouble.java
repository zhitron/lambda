 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionLongBooleanToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionLongBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongBooleanToDouble constant(double value) {
        return (v1, v2) -> value;
    }
