 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionBooleanDoubleToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionBooleanDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanDoubleToDouble constant(double value) {
        return (v1, v2) -> value;
    }
