 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleLongIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleLongIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongIntToFloat constant(float value) {
     ...
     */
    float apply(double v1, long v2, int v3);
}
