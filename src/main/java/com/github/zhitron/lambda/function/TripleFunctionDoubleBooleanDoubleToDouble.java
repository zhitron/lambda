 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleBooleanDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToDouble constant(double value) {
     ...
     */
    double apply(double v1, boolean v2, double v3);
}
