 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntDoubleIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntDoubleIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleIntToDouble constant(double value) {
     ...
     */
    double apply(int v1, double v2, int v3);
}
