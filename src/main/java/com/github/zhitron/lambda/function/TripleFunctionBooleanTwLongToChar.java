 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanTwLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanTwLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwLongToChar constant(char value) {
     ...
     */
    char apply(boolean v1, long v2, long v3);
}
