 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleToFloat constant(float value) {
     ...
     */
    float apply(double v1, double v2, double v3);
}
