 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionLongToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongToDouble constant(double value) {
        return (v1, v2) -> value;
    }
