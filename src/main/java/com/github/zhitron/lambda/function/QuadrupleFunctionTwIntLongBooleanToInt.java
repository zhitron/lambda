 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwIntLongBooleanToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongBooleanToInt constant(int value) {
     ...
     */
    int apply(int v1, int v2, long v3, boolean v4);
}
