 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanLongBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanLongBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongBooleanToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, long v2, boolean v3);
}
