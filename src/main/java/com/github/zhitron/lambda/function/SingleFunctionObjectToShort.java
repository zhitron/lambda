 ...
 */
@FunctionalInterface
public interface SingleFunctionObjectToShort<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    SingleFunctionObjectToShort<?> EMPTY = (v1) -> BasicConstant.SHORT_ZERO;
    ...
    static <T> SingleFunctionObjectToShort<T> empty() {
        return (SingleFunctionObjectToShort<T>) EMPTY;
    }
     ...
     */
    static <T> SingleFunctionObjectToShort<T> constant(short value) {
        return (v1) -> value;
    }
