 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanIntLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanIntLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntLongToShort constant(short value) {
     ...
     */
    short apply(boolean v1, int v2, long v3);
}
