 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionLongToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    QuadrupleFunctionLongToObject<?> EMPTY = (v1, v2, v3, v4) -> null;
    ...
    static <R> QuadrupleFunctionLongToObject<R> empty() {
        return (QuadrupleFunctionLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> QuadrupleFunctionLongToObject<R> constant(R value) {
     ...
     */
    R apply(long v1, long v2, long v3, long v4);
}
