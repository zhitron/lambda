 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionBooleanIntToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionBooleanIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanIntToShort constant(short value) {
        return (v1, v2) -> value;
    }
