 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwDoubleBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwDoubleBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleBooleanToDouble constant(double value) {
     ...
     */
    double apply(double v1, double v2, boolean v3);
}
