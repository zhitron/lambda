 ...
 */
@FunctionalInterface
public interface SingleFunctionDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    SingleFunctionDoubleToInt EMPTY = (v1) -> BasicConstant.INT_ZERO;
     ...
     */
    static SingleFunctionDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionDoubleToInt constant(int value) {
        return (v1) -> value;
    }
