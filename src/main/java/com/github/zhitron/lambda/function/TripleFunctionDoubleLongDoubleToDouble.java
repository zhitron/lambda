 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleLongDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleLongDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongDoubleToDouble constant(double value) {
     ...
     */
    double apply(double v1, long v2, double v3);
}
