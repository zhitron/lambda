 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongTwBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongTwBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwBooleanToInt constant(int value) {
     ...
     */
    int apply(long v1, boolean v2, boolean v3);
}
