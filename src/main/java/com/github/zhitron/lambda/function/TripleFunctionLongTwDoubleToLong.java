 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongTwDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongTwDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwDoubleToLong constant(long value) {
     ...
     */
    long apply(long v1, double v2, double v3);
}
