 ...
 */
@FunctionalInterface
public interface SingleFunctionBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    SingleFunctionBooleanToInt EMPTY = (v1) -> BasicConstant.INT_ZERO;
     ...
     */
    static SingleFunctionBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionBooleanToInt constant(int value) {
        return (v1) -> value;
    }
