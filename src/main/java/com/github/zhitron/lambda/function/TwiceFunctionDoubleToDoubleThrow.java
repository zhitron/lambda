 ...
 * 该接口扩展自 {@link TwiceFunctionDoubleToDouble}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface TwiceFunctionDoubleToDoubleThrow<E extends Exception> extends TwiceFunctionDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionDoubleToDoubleThrow<?> EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
    ...
    static <E extends Exception> TwiceFunctionDoubleToDoubleThrow<E> empty() {
        return (TwiceFunctionDoubleToDoubleThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TwiceFunctionDoubleToDoubleThrow<E> constant(double value) {
        return (v1, v2) -> value;
    }
