 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntLongIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntLongIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongIntToFloat constant(float value) {
     ...
     */
    float apply(int v1, long v2, int v3);
}
