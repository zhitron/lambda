 ...
 */
@FunctionalInterface
public interface TripleFunctionIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, int v3);
}
