 ...
 */
@FunctionalInterface
public interface SingleFunctionLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    SingleFunctionLongToLong EMPTY = (v1) -> BasicConstant.LONG_ZERO;
     ...
     */
    static SingleFunctionLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionLongToLong constant(long value) {
        return (v1) -> value;
    }
