 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntTwLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntTwLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwLongToFloat constant(float value) {
     ...
     */
    float apply(int v1, long v2, long v3);
}
