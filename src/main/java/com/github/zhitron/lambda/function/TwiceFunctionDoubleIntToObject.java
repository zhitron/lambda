 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionDoubleIntToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionDoubleIntToObject<R> empty() {
        return (TwiceFunctionDoubleIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionDoubleIntToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
