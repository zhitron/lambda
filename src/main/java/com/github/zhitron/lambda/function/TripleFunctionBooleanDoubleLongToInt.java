 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanDoubleLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleLongToInt constant(int value) {
     ...
     */
    int apply(boolean v1, double v2, long v3);
}
