 ...
 */
@FunctionalInterface
public interface TripleFunctionTwObjectIntToLong<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwObjectIntToLong<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectIntToLong<T, U> empty() {
        return (TripleFunctionTwObjectIntToLong<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectIntToLong<T, U> constant(long value) {
