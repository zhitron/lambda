 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionLongBooleanToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionLongBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongBooleanToLong constant(long value) {
        return (v1, v2) -> value;
    }
