 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwIntTwLongToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwLongToByte constant(byte value) {
     ...
     */
    byte apply(int v1, int v2, long v3, long v4);
}
