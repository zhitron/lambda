 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntDoubleLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntDoubleLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleLongToInt constant(int value) {
     ...
     */
    int apply(int v1, double v2, long v3);
}
