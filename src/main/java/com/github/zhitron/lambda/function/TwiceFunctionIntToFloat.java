 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionIntToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntToFloat constant(float value) {
        return (v1, v2) -> value;
    }
