 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwDoubleLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwDoubleLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleLongToShort constant(short value) {
     ...
     */
    short apply(double v1, double v2, long v3);
}
