 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongIntLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongIntLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntLongToChar constant(char value) {
     ...
     */
    char apply(long v1, int v2, long v3);
}
