 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongDoubleLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionTwLongDoubleLongToChar EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongDoubleLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongDoubleLongToChar constant(char value) {
     ...
     */
    char apply(long v1, long v2, double v3, long v4);
}
