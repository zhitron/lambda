 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongTwIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongTwIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwIntToDouble constant(double value) {
     ...
     */
    double apply(long v1, int v2, int v3);
}
