 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntBooleanLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntBooleanLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanLongToDouble constant(double value) {
     ...
     */
    double apply(int v1, boolean v2, long v3);
}
