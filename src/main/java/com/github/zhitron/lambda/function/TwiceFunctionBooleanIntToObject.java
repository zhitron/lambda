 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionBooleanIntToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionBooleanIntToObject<R> empty() {
        return (TwiceFunctionBooleanIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionBooleanIntToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
