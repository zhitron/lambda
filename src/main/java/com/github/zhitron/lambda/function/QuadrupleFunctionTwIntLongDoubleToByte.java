 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwIntLongDoubleToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToByte constant(byte value) {
     ...
     */
    byte apply(int v1, int v2, long v3, double v4);
}
