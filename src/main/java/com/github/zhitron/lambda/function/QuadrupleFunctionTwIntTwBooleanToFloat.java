 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwIntTwBooleanToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, boolean v3, boolean v4);
}
