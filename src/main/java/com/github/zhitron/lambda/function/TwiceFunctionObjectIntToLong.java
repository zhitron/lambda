 ...
 */
@FunctionalInterface
public interface TwiceFunctionObjectIntToLong<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionObjectIntToLong<?> EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
    ...
    static <T> TwiceFunctionObjectIntToLong<T> empty() {
        return (TwiceFunctionObjectIntToLong<T>) EMPTY;
    }
     ...
     */
    static <T> TwiceFunctionObjectIntToLong<T> constant(long value) {
        return (v1, v2) -> value;
    }
