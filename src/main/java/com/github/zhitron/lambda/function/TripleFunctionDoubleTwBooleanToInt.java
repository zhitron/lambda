 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleTwBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleTwBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwBooleanToInt constant(int value) {
     ...
     */
    int apply(double v1, boolean v2, boolean v3);
}
