...
public interface TripleFunctionTwBooleanLongToObject<R> {
     ...
     */
    TripleFunctionTwBooleanLongToObject<?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <R> TripleFunctionTwBooleanLongToObject<R> empty() {
        return (TripleFunctionTwBooleanLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TripleFunctionTwBooleanLongToObject<R> constant(R value) {
