 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwLongBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwLongBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongBooleanToChar constant(char value) {
     ...
     */
    char apply(long v1, long v2, boolean v3);
}
