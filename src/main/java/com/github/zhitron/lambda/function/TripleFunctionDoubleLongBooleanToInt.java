 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleLongBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleLongBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongBooleanToInt constant(int value) {
     ...
     */
    int apply(double v1, long v2, boolean v3);
}
