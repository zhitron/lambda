 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionDoubleBooleanToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionDoubleBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleBooleanToShort constant(short value) {
        return (v1, v2) -> value;
    }
     ...
     */
    short apply(double v1, boolean v2);
}
