 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwLongIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwLongIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongIntToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, int v3);
}
