 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwLongIntLongToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntLongToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, int v3, long v4);
}
