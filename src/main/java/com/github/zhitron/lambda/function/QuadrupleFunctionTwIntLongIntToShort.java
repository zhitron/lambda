 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwIntLongIntToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongIntToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, long v3, int v4);
}
