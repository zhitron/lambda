 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanTwLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanTwLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwLongToLong constant(long value) {
     ...
     */
    long apply(boolean v1, long v2, long v3);
}
