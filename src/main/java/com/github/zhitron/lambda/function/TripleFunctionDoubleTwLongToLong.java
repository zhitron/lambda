 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleTwLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleTwLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwLongToLong constant(long value) {
     ...
     */
    long apply(double v1, long v2, long v3);
}
