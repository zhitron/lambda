 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwDoubleIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwDoubleIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleIntToInt constant(int value) {
     ...
     */
    int apply(double v1, double v2, int v3);
}
