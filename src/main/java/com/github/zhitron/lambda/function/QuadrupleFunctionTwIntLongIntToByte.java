 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwIntLongIntToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongIntToByte constant(byte value) {
     ...
     */
    byte apply(int v1, int v2, long v3, int v4);
}
