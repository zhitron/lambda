 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwIntBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwIntBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntBooleanToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, boolean v3);
}
