 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionLongDoubleToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionLongDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongDoubleToChar constant(char value) {
        return (v1, v2) -> value;
    }
