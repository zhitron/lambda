 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionIntLongToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionIntLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntLongToDouble constant(double value) {
        return (v1, v2) -> value;
    }
