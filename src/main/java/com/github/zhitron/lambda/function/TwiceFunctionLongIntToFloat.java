 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionLongIntToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionLongIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongIntToFloat constant(float value) {
        return (v1, v2) -> value;
    }
