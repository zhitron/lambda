 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongTwDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongTwDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwDoubleToByte constant(byte value) {
     ...
     */
    byte apply(long v1, double v2, double v3);
}
