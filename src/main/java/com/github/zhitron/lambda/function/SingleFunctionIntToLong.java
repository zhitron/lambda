 ...
 */
@FunctionalInterface
public interface SingleFunctionIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    SingleFunctionIntToLong EMPTY = (v1) -> BasicConstant.LONG_ZERO;
     ...
     */
    static SingleFunctionIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionIntToLong constant(long value) {
        return (v1) -> value;
    }
