 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleLongDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleLongDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongDoubleToInt constant(int value) {
     ...
     */
    int apply(double v1, long v2, double v3);
}
