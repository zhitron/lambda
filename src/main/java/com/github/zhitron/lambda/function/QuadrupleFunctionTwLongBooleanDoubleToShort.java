 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanDoubleToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanDoubleToShort constant(short value) {
     ...
     */
    short apply(long v1, long v2, boolean v3, double v4);
}
