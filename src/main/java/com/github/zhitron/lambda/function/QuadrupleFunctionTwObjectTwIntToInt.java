 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwObjectTwIntToInt<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwObjectTwIntToInt<?, ?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
    ...
    static <T, U> QuadrupleFunctionTwObjectTwIntToInt<T, U> empty() {
        return (QuadrupleFunctionTwObjectTwIntToInt<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> QuadrupleFunctionTwObjectTwIntToInt<T, U> constant(int value) {
     ...
     */
    int apply(T v1, U v2, int v3, int v4);
}
