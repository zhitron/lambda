 ...
 */
@FunctionalInterface
public interface SingleFunctionFloatToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    SingleFunctionFloatToFloat EMPTY = (v1) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static SingleFunctionFloatToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionFloatToFloat constant(float value) {
        return (v1) -> value;
    }
