 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionBooleanIntToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionBooleanIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanIntToByte constant(byte value) {
        return (v1, v2) -> value;
    }
