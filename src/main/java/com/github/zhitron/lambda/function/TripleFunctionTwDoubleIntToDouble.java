 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwDoubleIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwDoubleIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleIntToDouble constant(double value) {
     ...
     */
    double apply(double v1, double v2, int v3);
}
