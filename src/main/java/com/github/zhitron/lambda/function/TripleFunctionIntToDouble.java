 ...
 */
@FunctionalInterface
public interface TripleFunctionIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntToDouble constant(double value) {
     ...
     */
    double apply(int v1, int v2, int v3);
}
