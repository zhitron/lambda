 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongIntBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongIntBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntBooleanToChar constant(char value) {
     ...
     */
    char apply(long v1, int v2, boolean v3);
}
