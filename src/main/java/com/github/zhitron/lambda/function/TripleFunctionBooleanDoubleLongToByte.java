 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanDoubleLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleLongToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, double v2, long v3);
}
