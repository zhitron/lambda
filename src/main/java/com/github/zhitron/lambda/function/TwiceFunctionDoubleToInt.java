 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionDoubleToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleToInt constant(int value) {
        return (v1, v2) -> value;
    }
