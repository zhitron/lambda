 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionBooleanToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanToLong constant(long value) {
        return (v1, v2) -> value;
    }
