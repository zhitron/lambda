 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwLongIntDoubleToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntDoubleToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, int v3, double v4);
}
