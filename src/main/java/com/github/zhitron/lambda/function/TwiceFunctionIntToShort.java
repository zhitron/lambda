 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionIntToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntToShort constant(short value) {
        return (v1, v2) -> value;
    }
