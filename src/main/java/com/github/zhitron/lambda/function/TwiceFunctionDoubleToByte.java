 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionDoubleToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleToByte constant(byte value) {
        return (v1, v2) -> value;
    }
