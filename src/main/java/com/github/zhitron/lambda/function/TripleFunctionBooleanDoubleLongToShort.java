 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanDoubleLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleLongToShort constant(short value) {
     ...
     */
    short apply(boolean v1, double v2, long v3);
}
