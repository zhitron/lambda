 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TripleFunctionDoubleToObject<?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <R> TripleFunctionDoubleToObject<R> empty() {
        return (TripleFunctionDoubleToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TripleFunctionDoubleToObject<R> constant(R value) {
     ...
     */
    R apply(double v1, double v2, double v3);
}
