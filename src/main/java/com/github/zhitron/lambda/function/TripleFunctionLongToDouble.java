 ...
 */
@FunctionalInterface
public interface TripleFunctionLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, long v3);
}
