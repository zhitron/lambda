 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntDoubleLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntDoubleLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleLongToDouble constant(double value) {
     ...
     */
    double apply(int v1, double v2, long v3);
}
