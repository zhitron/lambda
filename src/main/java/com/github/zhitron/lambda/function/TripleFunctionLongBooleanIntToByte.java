 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongBooleanIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongBooleanIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanIntToByte constant(byte value) {
     ...
     */
    byte apply(long v1, boolean v2, int v3);
}
