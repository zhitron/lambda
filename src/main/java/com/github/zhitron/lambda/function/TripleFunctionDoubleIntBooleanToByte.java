 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleIntBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleIntBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntBooleanToByte constant(byte value) {
     ...
     */
    byte apply(double v1, int v2, boolean v3);
}
