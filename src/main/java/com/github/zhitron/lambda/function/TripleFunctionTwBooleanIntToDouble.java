 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwBooleanIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwBooleanIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanIntToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, boolean v2, int v3);
}
