 ...
 */
@FunctionalInterface
public interface TripleFunctionTwObjectIntToShort<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwObjectIntToShort<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectIntToShort<T, U> empty() {
        return (TripleFunctionTwObjectIntToShort<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectIntToShort<T, U> constant(short value) {
