 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanTwLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanTwLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwLongToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, long v2, long v3);
}
