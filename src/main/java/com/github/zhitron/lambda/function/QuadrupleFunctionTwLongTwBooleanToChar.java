 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionTwLongTwBooleanToChar EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwBooleanToChar constant(char value) {
     ...
     */
    char apply(long v1, long v2, boolean v3, boolean v4);
}
