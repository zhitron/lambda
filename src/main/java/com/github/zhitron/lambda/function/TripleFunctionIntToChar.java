 ...
 */
@FunctionalInterface
public interface TripleFunctionIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntToChar constant(char value) {
     ...
     */
    char apply(int v1, int v2, int v3);
}
