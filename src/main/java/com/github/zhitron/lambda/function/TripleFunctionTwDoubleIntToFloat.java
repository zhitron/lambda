 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwDoubleIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwDoubleIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleIntToFloat constant(float value) {
     ...
     */
    float apply(double v1, double v2, int v3);
}
