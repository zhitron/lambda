 ...
 */
@FunctionalInterface
public interface SingleFunctionObjectToInt<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    SingleFunctionObjectToInt<?> EMPTY = (v1) -> BasicConstant.INT_ZERO;
    ...
    static <T> SingleFunctionObjectToInt<T> empty() {
        return (SingleFunctionObjectToInt<T>) EMPTY;
    }
     ...
     */
    static <T> SingleFunctionObjectToInt<T> constant(int value) {
        return (v1) -> value;
    }
