 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongIntLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongIntLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntLongToFloat constant(float value) {
     ...
     */
    float apply(long v1, int v2, long v3);
}
