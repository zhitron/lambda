 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwBooleanIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwBooleanIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanIntToChar constant(char value) {
     ...
     */
    char apply(boolean v1, boolean v2, int v3);
}
