 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongTwDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongTwDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwDoubleToChar constant(char value) {
     ...
     */
    char apply(long v1, double v2, double v3);
}
