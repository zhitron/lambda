 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionBooleanIntToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionBooleanIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanIntToInt constant(int value) {
        return (v1, v2) -> value;
    }
