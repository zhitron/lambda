 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongTwIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongTwIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwIntToChar constant(char value) {
     ...
     */
    char apply(long v1, int v2, int v3);
}
