 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionDoubleBooleanToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionDoubleBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleBooleanToFloat constant(float value) {
        return (v1, v2) -> value;
    }
