 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionLongToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongToLong constant(long value) {
        return (v1, v2) -> value;
    }
