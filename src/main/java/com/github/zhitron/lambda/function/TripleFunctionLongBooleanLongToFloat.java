 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongBooleanLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongBooleanLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanLongToFloat constant(float value) {
     ...
     */
    float apply(long v1, boolean v2, long v3);
}
