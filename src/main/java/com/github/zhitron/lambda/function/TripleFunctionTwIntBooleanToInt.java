 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwIntBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwIntBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntBooleanToInt constant(int value) {
     ...
     */
    int apply(int v1, int v2, boolean v3);
}
