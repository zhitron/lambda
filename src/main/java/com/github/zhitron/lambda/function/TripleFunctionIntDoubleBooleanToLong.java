 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntDoubleBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntDoubleBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleBooleanToLong constant(long value) {
     ...
     */
    long apply(int v1, double v2, boolean v3);
}
