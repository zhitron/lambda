 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongIntDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongIntDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntDoubleToShort constant(short value) {
     ...
     */
    short apply(long v1, int v2, double v3);
}
