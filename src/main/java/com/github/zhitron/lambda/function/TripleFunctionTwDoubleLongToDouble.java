 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwDoubleLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwDoubleLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleLongToDouble constant(double value) {
     ...
     */
    double apply(double v1, double v2, long v3);
}
