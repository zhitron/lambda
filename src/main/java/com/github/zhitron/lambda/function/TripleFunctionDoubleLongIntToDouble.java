 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleLongIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleLongIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongIntToDouble constant(double value) {
     ...
     */
    double apply(double v1, long v2, int v3);
}
