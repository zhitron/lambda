...
public interface SingleFunctionLongToObjectThrow<R, E extends Exception> extends SingleFunctionLongToObject<R> {
     ...
     */
    SingleFunctionLongToObjectThrow<?, ?> EMPTY = (v1) -> null;
    ...
    static <R, E extends Exception> SingleFunctionLongToObjectThrow<R, E> empty() {
        return (SingleFunctionLongToObjectThrow<R, E>) EMPTY;
    }
     ...
     */
    static <R, E extends Exception> SingleFunctionLongToObjectThrow<R, E> constant(R value) {
        return (v1) -> value;
    }
