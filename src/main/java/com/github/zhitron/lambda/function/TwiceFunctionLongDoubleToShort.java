 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionLongDoubleToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionLongDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongDoubleToShort constant(short value) {
        return (v1, v2) -> value;
    }
