 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleIntBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleIntBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntBooleanToChar constant(char value) {
     ...
     */
    char apply(double v1, int v2, boolean v3);
}
