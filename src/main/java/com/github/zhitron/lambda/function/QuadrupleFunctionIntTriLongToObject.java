 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionIntTriLongToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    QuadrupleFunctionIntTriLongToObject<?> EMPTY = (v1, v2, v3, v4) -> null;
    ...
    static <R> QuadrupleFunctionIntTriLongToObject<R> empty() {
        return (QuadrupleFunctionIntTriLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> QuadrupleFunctionIntTriLongToObject<R> constant(R value) {
     ...
     */
    R apply(int v1, long v2, long v3, long v4);
}
