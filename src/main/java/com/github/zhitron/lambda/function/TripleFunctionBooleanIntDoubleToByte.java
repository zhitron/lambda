 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanIntDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanIntDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntDoubleToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, int v2, double v3);
}
