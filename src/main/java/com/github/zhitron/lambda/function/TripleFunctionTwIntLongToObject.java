 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntLongToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TripleFunctionTwIntLongToObject<?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <R> TripleFunctionTwIntLongToObject<R> empty() {
        return (TripleFunctionTwIntLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TripleFunctionTwIntLongToObject<R> constant(R value) {
