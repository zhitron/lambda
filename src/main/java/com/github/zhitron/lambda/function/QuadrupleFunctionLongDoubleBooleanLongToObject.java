...
public interface QuadrupleFunctionLongDoubleBooleanLongToObject<R> {
     ...
     */
    QuadrupleFunctionLongDoubleBooleanLongToObject<?> EMPTY = (v1, v2, v3, v4) -> null;
    ...
    static <R> QuadrupleFunctionLongDoubleBooleanLongToObject<R> empty() {
        return (QuadrupleFunctionLongDoubleBooleanLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> QuadrupleFunctionLongDoubleBooleanLongToObject<R> constant(R value) {
