 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwIntTwDoubleToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwDoubleToInt constant(int value) {
     ...
     */
    int apply(int v1, int v2, double v3, double v4);
}
