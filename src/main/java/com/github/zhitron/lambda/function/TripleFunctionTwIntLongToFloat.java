 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwIntLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwIntLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntLongToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, long v3);
}
