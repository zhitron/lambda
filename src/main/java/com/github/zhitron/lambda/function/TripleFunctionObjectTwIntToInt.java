 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectTwIntToInt<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionObjectTwIntToInt<?> EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
    ...
    static <T> TripleFunctionObjectTwIntToInt<T> empty() {
        return (TripleFunctionObjectTwIntToInt<T>) EMPTY;
    }
     ...
     */
    static <T> TripleFunctionObjectTwIntToInt<T> constant(int value) {
