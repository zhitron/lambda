 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanIntToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanIntToShort constant(short value) {
     ...
     */
    short apply(long v1, long v2, boolean v3, int v4);
}
