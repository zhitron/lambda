 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleIntBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleIntBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntBooleanToShort constant(short value) {
     ...
     */
    short apply(double v1, int v2, boolean v3);
}
