 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleBooleanLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanLongToShort constant(short value) {
     ...
     */
    short apply(double v1, boolean v2, long v3);
}
