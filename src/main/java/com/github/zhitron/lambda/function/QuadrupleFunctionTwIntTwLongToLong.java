 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwIntTwLongToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwLongToLong constant(long value) {
     ...
     */
    long apply(int v1, int v2, long v3, long v4);
}
