 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanIntBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanIntBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntBooleanToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, int v2, boolean v3);
}
