 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleBooleanDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToInt constant(int value) {
     ...
     */
    int apply(double v1, boolean v2, double v3);
}
