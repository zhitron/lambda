 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwBooleanDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwBooleanDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanDoubleToShort constant(short value) {
     ...
     */
    short apply(boolean v1, boolean v2, double v3);
}
