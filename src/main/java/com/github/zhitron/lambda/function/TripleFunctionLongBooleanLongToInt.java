 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongBooleanLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongBooleanLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanLongToInt constant(int value) {
     ...
     */
    int apply(long v1, boolean v2, long v3);
}
