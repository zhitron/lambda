 ...
 */
@FunctionalInterface
public interface SingleFunctionFloatToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    SingleFunctionFloatToChar EMPTY = (v1) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static SingleFunctionFloatToChar empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionFloatToChar constant(char value) {
        return (v1) -> value;
    }
