 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleBooleanDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToShort constant(short value) {
     ...
     */
    short apply(double v1, boolean v2, double v3);
}
