 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleLongDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleLongDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongDoubleToShort constant(short value) {
     ...
     */
    short apply(double v1, long v2, double v3);
}
