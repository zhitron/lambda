 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwDoubleBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwDoubleBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleBooleanToFloat constant(float value) {
     ...
     */
    float apply(double v1, double v2, boolean v3);
}
