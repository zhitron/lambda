 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongBooleanLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongBooleanLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanLongToShort constant(short value) {
     ...
     */
    short apply(long v1, boolean v2, long v3);
}
