 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionBooleanToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanToDouble constant(double value) {
        return (v1, v2) -> value;
    }
