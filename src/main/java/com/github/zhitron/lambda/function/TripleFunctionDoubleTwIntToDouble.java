 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleTwIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleTwIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwIntToDouble constant(double value) {
     ...
     */
    double apply(double v1, int v2, int v3);
}
