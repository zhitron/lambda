 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanTwIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanTwIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwIntToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, int v2, int v3);
}
