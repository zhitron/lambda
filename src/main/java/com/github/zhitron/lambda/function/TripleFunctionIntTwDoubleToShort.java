 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntTwDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntTwDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwDoubleToShort constant(short value) {
     ...
     */
    short apply(int v1, double v2, double v3);
}
