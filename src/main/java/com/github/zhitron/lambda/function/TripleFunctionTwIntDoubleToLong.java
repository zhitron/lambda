 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwIntDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwIntDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntDoubleToLong constant(long value) {
     ...
     */
    long apply(int v1, int v2, double v3);
}
