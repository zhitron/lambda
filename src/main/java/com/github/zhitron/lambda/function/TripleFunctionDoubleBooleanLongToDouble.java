 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleBooleanLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanLongToDouble constant(double value) {
     ...
     */
    double apply(double v1, boolean v2, long v3);
}
