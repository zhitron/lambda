 ...
 */
@FunctionalInterface
public interface TripleFunctionTwObjectLongToByte<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwObjectLongToByte<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectLongToByte<T, U> empty() {
        return (TripleFunctionTwObjectLongToByte<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectLongToByte<T, U> constant(byte value) {
