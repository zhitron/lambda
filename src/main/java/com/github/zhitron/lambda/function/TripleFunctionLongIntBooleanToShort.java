 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongIntBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongIntBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntBooleanToShort constant(short value) {
     ...
     */
    short apply(long v1, int v2, boolean v3);
}
