 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwIntTwDoubleToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwDoubleToByte constant(byte value) {
     ...
     */
    byte apply(int v1, int v2, double v3, double v4);
}
