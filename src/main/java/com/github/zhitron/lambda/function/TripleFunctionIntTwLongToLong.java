 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntTwLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntTwLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwLongToLong constant(long value) {
     ...
     */
    long apply(int v1, long v2, long v3);
}
