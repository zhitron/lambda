 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionDoubleToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleToShort constant(short value) {
        return (v1, v2) -> value;
    }
