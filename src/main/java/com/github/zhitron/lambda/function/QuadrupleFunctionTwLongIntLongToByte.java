 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    QuadrupleFunctionTwLongIntLongToByte EMPTY = (v1, v2, v3, v4) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntLongToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, int v3, long v4);
}
