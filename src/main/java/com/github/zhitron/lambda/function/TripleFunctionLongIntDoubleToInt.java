 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongIntDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongIntDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntDoubleToInt constant(int value) {
     ...
     */
    int apply(long v1, int v2, double v3);
}
