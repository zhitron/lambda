 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongTwIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongTwIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwIntToLong constant(long value) {
     ...
     */
    long apply(long v1, int v2, int v3);
}
