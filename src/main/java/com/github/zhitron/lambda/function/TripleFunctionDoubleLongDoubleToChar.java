 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleLongDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleLongDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongDoubleToChar constant(char value) {
     ...
     */
    char apply(double v1, long v2, double v3);
}
