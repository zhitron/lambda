 ...
 */
@FunctionalInterface
public interface TwiceFunctionObjectToChar<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionObjectToChar<?, ?> EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
    ...
    static <T, U> TwiceFunctionObjectToChar<T, U> empty() {
        return (TwiceFunctionObjectToChar<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TwiceFunctionObjectToChar<T, U> constant(char value) {
        return (v1, v2) -> value;
    }
