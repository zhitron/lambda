 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongIntBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongIntBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntBooleanToInt constant(int value) {
     ...
     */
    int apply(long v1, int v2, boolean v3);
}
