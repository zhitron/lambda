 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwBooleanDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwBooleanDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanDoubleToChar constant(char value) {
     ...
     */
    char apply(boolean v1, boolean v2, double v3);
}
