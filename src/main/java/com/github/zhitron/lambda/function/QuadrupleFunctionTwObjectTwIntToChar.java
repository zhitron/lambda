 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwObjectTwIntToChar<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionTwObjectTwIntToChar<?, ?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
    ...
    static <T, U> QuadrupleFunctionTwObjectTwIntToChar<T, U> empty() {
        return (QuadrupleFunctionTwObjectTwIntToChar<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> QuadrupleFunctionTwObjectTwIntToChar<T, U> constant(char value) {
     ...
     */
    char apply(T v1, U v2, int v3, int v4);
}
