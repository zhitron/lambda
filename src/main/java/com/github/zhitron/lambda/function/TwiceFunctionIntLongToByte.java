 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionIntLongToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionIntLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntLongToByte constant(byte value) {
        return (v1, v2) -> value;
    }
