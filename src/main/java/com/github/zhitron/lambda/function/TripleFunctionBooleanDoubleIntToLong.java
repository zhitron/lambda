 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionBooleanDoubleIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleIntToLong constant(long value) {
     ...
     */
    long apply(boolean v1, double v2, int v3);
}
