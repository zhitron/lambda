 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntBooleanDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntBooleanDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanDoubleToLong constant(long value) {
     ...
     */
    long apply(int v1, boolean v2, double v3);
}
