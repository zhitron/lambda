 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongIntLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongIntLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntLongToDouble constant(double value) {
     ...
     */
    double apply(long v1, int v2, long v3);
}
