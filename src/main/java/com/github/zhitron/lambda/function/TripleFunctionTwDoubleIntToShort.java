 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionTwDoubleIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionTwDoubleIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleIntToShort constant(short value) {
     ...
     */
    short apply(double v1, double v2, int v3);
}
