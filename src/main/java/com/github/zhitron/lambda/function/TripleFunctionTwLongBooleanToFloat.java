 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwLongBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwLongBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongBooleanToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, boolean v3);
}
