 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanDoubleIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleIntToInt constant(int value) {
     ...
     */
    int apply(boolean v1, double v2, int v3);
}
