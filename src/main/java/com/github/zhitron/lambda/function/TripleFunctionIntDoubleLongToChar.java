 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntDoubleLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntDoubleLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleLongToChar constant(char value) {
     ...
     */
    char apply(int v1, double v2, long v3);
}
