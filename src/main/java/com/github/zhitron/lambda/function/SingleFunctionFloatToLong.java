 ...
 */
@FunctionalInterface
public interface SingleFunctionFloatToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    SingleFunctionFloatToLong EMPTY = (v1) -> BasicConstant.LONG_ZERO;
     ...
     */
    static SingleFunctionFloatToLong empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionFloatToLong constant(long value) {
        return (v1) -> value;
    }
