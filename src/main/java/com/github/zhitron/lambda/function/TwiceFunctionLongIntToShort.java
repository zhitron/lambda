 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionLongIntToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionLongIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongIntToShort constant(short value) {
        return (v1, v2) -> value;
    }
