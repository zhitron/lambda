 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntDoubleIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntDoubleIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleIntToFloat constant(float value) {
     ...
     */
    float apply(int v1, double v2, int v3);
}
