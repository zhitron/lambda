 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleBooleanLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanLongToChar constant(char value) {
     ...
     */
    char apply(double v1, boolean v2, long v3);
}
