 ...
 */
@FunctionalInterface
public interface TripleFunctionIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntToInt constant(int value) {
