 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleBooleanDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanDoubleToFloat constant(float value) {
     ...
     */
    float apply(double v1, boolean v2, double v3);
}
