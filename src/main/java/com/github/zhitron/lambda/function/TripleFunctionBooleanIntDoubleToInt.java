 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanIntDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanIntDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntDoubleToInt constant(int value) {
     ...
     */
    int apply(boolean v1, int v2, double v3);
}
