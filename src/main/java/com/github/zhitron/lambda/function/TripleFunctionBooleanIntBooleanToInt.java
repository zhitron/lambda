 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionBooleanIntBooleanToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionBooleanIntBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntBooleanToInt constant(int value) {
     ...
     */
    int apply(boolean v1, int v2, boolean v3);
}
