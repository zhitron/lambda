 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwBooleanIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwBooleanIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanIntToLong constant(long value) {
     ...
     */
    long apply(boolean v1, boolean v2, int v3);
}
