 ...
 */
@FunctionalInterface
public interface SingleFunctionByteToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    SingleFunctionByteToDouble EMPTY = (v1) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static SingleFunctionByteToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionByteToDouble constant(double value) {
        return (v1) -> value;
    }
