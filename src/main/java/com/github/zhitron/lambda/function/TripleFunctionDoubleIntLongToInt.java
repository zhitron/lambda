 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleIntLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleIntLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntLongToInt constant(int value) {
     ...
     */
    int apply(double v1, int v2, long v3);
}
