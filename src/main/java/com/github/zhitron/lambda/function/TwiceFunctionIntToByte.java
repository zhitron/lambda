 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionIntToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntToByte constant(byte value) {
        return (v1, v2) -> value;
    }
