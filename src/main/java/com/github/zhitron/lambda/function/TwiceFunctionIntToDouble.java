 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionIntToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntToDouble constant(double value) {
        return (v1, v2) -> value;
    }
