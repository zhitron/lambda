 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwLongToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TripleFunctionIntTwLongToObject<?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <R> TripleFunctionIntTwLongToObject<R> empty() {
        return (TripleFunctionIntTwLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TripleFunctionIntTwLongToObject<R> constant(R value) {
     ...
     */
    R apply(int v1, long v2, long v3);
}
