 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleTwIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleTwIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwIntToLong constant(long value) {
     ...
     */
    long apply(double v1, int v2, int v3);
}
