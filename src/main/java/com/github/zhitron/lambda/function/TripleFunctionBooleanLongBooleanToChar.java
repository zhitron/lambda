 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanLongBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanLongBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongBooleanToChar constant(char value) {
     ...
     */
    char apply(boolean v1, long v2, boolean v3);
}
