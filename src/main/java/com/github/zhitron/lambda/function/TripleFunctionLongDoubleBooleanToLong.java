 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongDoubleBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongDoubleBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleBooleanToLong constant(long value) {
     ...
     */
    long apply(long v1, double v2, boolean v3);
}
