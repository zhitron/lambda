 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwBooleanLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwBooleanLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanLongToLong constant(long value) {
     ...
     */
    long apply(boolean v1, boolean v2, long v3);
}
