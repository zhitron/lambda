 ...
 */
@FunctionalInterface
public interface TripleFunctionTwObjectIntToFloat<T, U> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwObjectIntToFloat<?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
    ...
    static <T, U> TripleFunctionTwObjectIntToFloat<T, U> empty() {
        return (TripleFunctionTwObjectIntToFloat<T, U>) EMPTY;
    }
     ...
     */
    static <T, U> TripleFunctionTwObjectIntToFloat<T, U> constant(float value) {
