 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongBooleanIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwLongBooleanIntToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongBooleanIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongBooleanIntToLong constant(long value) {
     ...
     */
    long apply(long v1, long v2, boolean v3, int v4);
}
