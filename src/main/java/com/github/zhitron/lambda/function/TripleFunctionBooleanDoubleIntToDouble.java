 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanDoubleIntToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleIntToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, double v2, int v3);
}
