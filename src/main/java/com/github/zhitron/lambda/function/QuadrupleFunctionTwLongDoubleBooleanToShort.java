 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongDoubleBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwLongDoubleBooleanToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongDoubleBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongDoubleBooleanToShort constant(short value) {
     ...
     */
    short apply(long v1, long v2, double v3, boolean v4);
}
