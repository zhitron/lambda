 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanDoubleLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleLongToChar constant(char value) {
     ...
     */
    char apply(boolean v1, double v2, long v3);
}
