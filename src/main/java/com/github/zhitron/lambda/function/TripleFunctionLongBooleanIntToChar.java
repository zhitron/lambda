 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongBooleanIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongBooleanIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanIntToChar constant(char value) {
     ...
     */
    char apply(long v1, boolean v2, int v3);
}
