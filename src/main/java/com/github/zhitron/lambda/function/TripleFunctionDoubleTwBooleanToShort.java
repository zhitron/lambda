 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionDoubleTwBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionDoubleTwBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwBooleanToShort constant(short value) {
     ...
     */
    short apply(double v1, boolean v2, boolean v3);
}
