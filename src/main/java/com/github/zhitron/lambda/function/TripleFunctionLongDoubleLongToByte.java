 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongDoubleLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongDoubleLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleLongToByte constant(byte value) {
     ...
     */
    byte apply(long v1, double v2, long v3);
}
