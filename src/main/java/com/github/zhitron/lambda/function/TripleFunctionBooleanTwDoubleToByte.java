 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionBooleanTwDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionBooleanTwDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwDoubleToByte constant(byte value) {
     ...
     */
    byte apply(boolean v1, double v2, double v3);
}
