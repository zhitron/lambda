 ...
 * 该接口扩展自 {@link QuadrupleFunctionLongToLong}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface QuadrupleFunctionLongToLongThrow<E extends Exception> extends QuadrupleFunctionLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionLongToLongThrow<?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
    ...
    static <E extends Exception> QuadrupleFunctionLongToLongThrow<E> empty() {
        return (QuadrupleFunctionLongToLongThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> QuadrupleFunctionLongToLongThrow<E> constant(long value) {
