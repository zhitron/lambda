 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    QuadrupleFunctionTwIntTwBooleanToChar EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToChar constant(char value) {
     ...
     */
    char apply(int v1, int v2, boolean v3, boolean v4);
}
