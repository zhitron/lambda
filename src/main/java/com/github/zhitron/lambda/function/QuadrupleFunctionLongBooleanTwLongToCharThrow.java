...
public interface QuadrupleFunctionLongBooleanTwLongToCharThrow<E extends Exception> extends QuadrupleFunctionLongBooleanTwLongToChar {
     ...
     */
    QuadrupleFunctionLongBooleanTwLongToCharThrow<?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.CHAR_ZERO;
    ...
    static <E extends Exception> QuadrupleFunctionLongBooleanTwLongToCharThrow<E> empty() {
        return (QuadrupleFunctionLongBooleanTwLongToCharThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> QuadrupleFunctionLongBooleanTwLongToCharThrow<E> constant(char value) {
