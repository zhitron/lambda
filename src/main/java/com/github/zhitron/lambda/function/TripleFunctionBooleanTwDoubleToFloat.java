 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanTwDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanTwDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwDoubleToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, double v2, double v3);
}
