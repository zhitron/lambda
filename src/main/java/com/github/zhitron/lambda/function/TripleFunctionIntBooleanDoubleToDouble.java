 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntBooleanDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntBooleanDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanDoubleToDouble constant(double value) {
     ...
     */
    double apply(int v1, boolean v2, double v3);
}
