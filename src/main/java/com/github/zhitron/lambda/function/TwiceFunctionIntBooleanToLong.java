 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionIntBooleanToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionIntBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntBooleanToLong constant(long value) {
        return (v1, v2) -> value;
    }
