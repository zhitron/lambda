 ...
 */
@FunctionalInterface
public interface TripleFunctionLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, long v3);
}
