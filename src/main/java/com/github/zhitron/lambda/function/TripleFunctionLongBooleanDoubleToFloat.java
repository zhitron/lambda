 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongBooleanDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongBooleanDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanDoubleToFloat constant(float value) {
     ...
     */
    float apply(long v1, boolean v2, double v3);
}
