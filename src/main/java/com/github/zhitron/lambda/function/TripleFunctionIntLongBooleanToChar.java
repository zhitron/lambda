 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntLongBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntLongBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongBooleanToChar constant(char value) {
     ...
     */
    char apply(int v1, long v2, boolean v3);
}
