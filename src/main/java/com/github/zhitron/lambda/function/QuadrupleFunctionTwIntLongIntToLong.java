 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwIntLongIntToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongIntToLong constant(long value) {
     ...
     */
    long apply(int v1, int v2, long v3, int v4);
}
