 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionBooleanDoubleToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionBooleanDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanDoubleToLong constant(long value) {
        return (v1, v2) -> value;
    }
