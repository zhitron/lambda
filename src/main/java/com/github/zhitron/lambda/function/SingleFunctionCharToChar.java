 ...
 */
@FunctionalInterface
public interface SingleFunctionCharToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    SingleFunctionCharToChar EMPTY = (v1) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static SingleFunctionCharToChar empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionCharToChar constant(char value) {
        return (v1) -> value;
    }
