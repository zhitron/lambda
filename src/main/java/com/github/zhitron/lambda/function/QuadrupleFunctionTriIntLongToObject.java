 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTriIntLongToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    QuadrupleFunctionTriIntLongToObject<?> EMPTY = (v1, v2, v3, v4) -> null;
    ...
    static <R> QuadrupleFunctionTriIntLongToObject<R> empty() {
        return (QuadrupleFunctionTriIntLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> QuadrupleFunctionTriIntLongToObject<R> constant(R value) {
     ...
     */
    R apply(int v1, int v2, int v3, long v4);
}
