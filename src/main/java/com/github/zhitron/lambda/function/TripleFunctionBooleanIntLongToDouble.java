 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionBooleanIntLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionBooleanIntLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntLongToDouble constant(double value) {
     ...
     */
    double apply(boolean v1, int v2, long v3);
}
