 ...
 */
@FunctionalInterface
public interface TripleFunctionLongToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TripleFunctionLongToObject<?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <R> TripleFunctionLongToObject<R> empty() {
        return (TripleFunctionLongToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TripleFunctionLongToObject<R> constant(R value) {
     ...
     */
    R apply(long v1, long v2, long v3);
}
