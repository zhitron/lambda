 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntTwBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntTwBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwBooleanToFloat constant(float value) {
     ...
     */
    float apply(int v1, boolean v2, boolean v3);
}
