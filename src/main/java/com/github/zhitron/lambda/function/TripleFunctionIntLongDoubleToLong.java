 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntLongDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntLongDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongDoubleToLong constant(long value) {
     ...
     */
    long apply(int v1, long v2, double v3);
}
