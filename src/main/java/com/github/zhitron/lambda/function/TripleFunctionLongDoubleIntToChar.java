 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongDoubleIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongDoubleIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleIntToChar constant(char value) {
     ...
     */
    char apply(long v1, double v2, int v3);
}
