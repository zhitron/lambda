 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleTwLongToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleTwLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwLongToDouble constant(double value) {
     ...
     */
    double apply(double v1, long v2, long v3);
}
