 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionDoubleTwBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionDoubleTwBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwBooleanToByte constant(byte value) {
     ...
     */
    byte apply(double v1, boolean v2, boolean v3);
}
