 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionObjectToInt<T, U, V, O> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionObjectToInt<?, ?, ?, ?> EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
    ...
    static <T, U, V, O> QuadrupleFunctionObjectToInt<T, U, V, O> empty() {
        return (QuadrupleFunctionObjectToInt<T, U, V, O>) EMPTY;
    }
     ...
     */
    static <T, U, V, O> QuadrupleFunctionObjectToInt<T, U, V, O> constant(int value) {
