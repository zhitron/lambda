 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleBooleanToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionBooleanDoubleBooleanToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToFloat constant(float value) {
     ...
     */
    float apply(boolean v1, double v2, boolean v3);
}
