 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwIntLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwIntLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntLongToLong constant(long value) {
     ...
     */
    long apply(int v1, int v2, long v3);
}
