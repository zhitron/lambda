 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionLongDoubleBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionLongDoubleBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleBooleanToDouble constant(double value) {
     ...
     */
    double apply(long v1, double v2, boolean v3);
}
