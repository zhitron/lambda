 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionIntLongToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionIntLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntLongToShort constant(short value) {
        return (v1, v2) -> value;
    }
