 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionDoubleLongBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionDoubleLongBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongBooleanToDouble constant(double value) {
     ...
     */
    double apply(double v1, long v2, boolean v3);
}
