 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongDoubleBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongDoubleBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleBooleanToByte constant(byte value) {
     ...
     */
    byte apply(long v1, double v2, boolean v3);
}
