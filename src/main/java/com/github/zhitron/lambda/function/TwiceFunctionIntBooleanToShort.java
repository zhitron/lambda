 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionIntBooleanToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionIntBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntBooleanToShort constant(short value) {
        return (v1, v2) -> value;
    }
