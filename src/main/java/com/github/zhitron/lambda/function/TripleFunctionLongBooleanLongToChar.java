 ...
 */
@FunctionalInterface
public interface TripleFunctionLongBooleanLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongBooleanLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongBooleanLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongBooleanLongToChar constant(char value) {
     ...
     */
    char apply(long v1, boolean v2, long v3);
}
