 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionDoubleBooleanToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionDoubleBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleBooleanToByte constant(byte value) {
        return (v1, v2) -> value;
    }
