 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionIntBooleanIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionIntBooleanIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanIntToFloat constant(float value) {
     ...
     */
    float apply(int v1, boolean v2, int v3);
}
