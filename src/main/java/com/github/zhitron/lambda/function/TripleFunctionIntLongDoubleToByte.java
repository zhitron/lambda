 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntLongDoubleToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntLongDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongDoubleToByte constant(byte value) {
     ...
     */
    byte apply(int v1, long v2, double v3);
}
