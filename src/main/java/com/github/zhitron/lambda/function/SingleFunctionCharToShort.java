 ...
 */
@FunctionalInterface
public interface SingleFunctionCharToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    SingleFunctionCharToShort EMPTY = (v1) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static SingleFunctionCharToShort empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionCharToShort constant(short value) {
        return (v1) -> value;
    }
