 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleIntLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleIntLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntLongToFloat constant(float value) {
     ...
     */
    float apply(double v1, int v2, long v3);
}
