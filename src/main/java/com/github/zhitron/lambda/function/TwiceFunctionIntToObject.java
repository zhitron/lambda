 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TwiceFunctionIntToObject<?> EMPTY = (v1, v2) -> null;
    ...
    static <R> TwiceFunctionIntToObject<R> empty() {
        return (TwiceFunctionIntToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TwiceFunctionIntToObject<R> constant(R value) {
        return (v1, v2) -> value;
    }
