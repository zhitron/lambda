...
public interface TripleFunctionObjectTwDoubleToFloat<T> {
     ...
     */
    TripleFunctionObjectTwDoubleToFloat<?> EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
    ...
    static <T> TripleFunctionObjectTwDoubleToFloat<T> empty() {
        return (TripleFunctionObjectTwDoubleToFloat<T>) EMPTY;
    }
     ...
     */
    static <T> TripleFunctionObjectTwDoubleToFloat<T> constant(float value) {
