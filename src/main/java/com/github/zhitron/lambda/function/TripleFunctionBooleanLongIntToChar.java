 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanLongIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanLongIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongIntToChar constant(char value) {
     ...
     */
    char apply(boolean v1, long v2, int v3);
}
