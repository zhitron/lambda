 ...
 */
@FunctionalInterface
public interface SingleFunctionCharToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    SingleFunctionCharToInt EMPTY = (v1) -> BasicConstant.INT_ZERO;
     ...
     */
    static SingleFunctionCharToInt empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionCharToInt constant(int value) {
        return (v1) -> value;
    }
