 ...
 */
@FunctionalInterface
public interface SingleFunctionByteToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    SingleFunctionByteToByte EMPTY = (v1) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static SingleFunctionByteToByte empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionByteToByte constant(byte value) {
        return (v1) -> value;
    }
