 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongIntLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    QuadrupleFunctionTwLongIntLongToInt EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongIntLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongIntLongToInt constant(int value) {
     ...
     */
    int apply(long v1, long v2, int v3, long v4);
}
