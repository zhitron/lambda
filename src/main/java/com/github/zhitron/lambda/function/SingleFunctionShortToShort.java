 ...
 */
@FunctionalInterface
public interface SingleFunctionShortToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    SingleFunctionShortToShort EMPTY = (v1) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static SingleFunctionShortToShort empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionShortToShort constant(short value) {
        return (v1) -> value;
    }
