 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionBooleanIntToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionBooleanIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanIntToLong constant(long value) {
        return (v1, v2) -> value;
    }
