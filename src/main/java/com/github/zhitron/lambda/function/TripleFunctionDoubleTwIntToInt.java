 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleTwIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleTwIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwIntToInt constant(int value) {
     ...
     */
    int apply(double v1, int v2, int v3);
}
