 ...
 */
@FunctionalInterface
public interface TripleFunctionLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongToChar constant(char value) {
     ...
     */
    char apply(long v1, long v2, long v3);
}
