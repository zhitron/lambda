 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionLongBooleanToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionLongBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongBooleanToShort constant(short value) {
        return (v1, v2) -> value;
    }
