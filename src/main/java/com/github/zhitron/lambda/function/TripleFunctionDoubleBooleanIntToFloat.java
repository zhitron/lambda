 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleBooleanIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleBooleanIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleBooleanIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleBooleanIntToFloat constant(float value) {
     ...
     */
    float apply(double v1, boolean v2, int v3);
}
