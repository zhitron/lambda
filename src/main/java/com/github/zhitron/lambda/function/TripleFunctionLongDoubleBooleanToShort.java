 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongDoubleBooleanToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongDoubleBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleBooleanToShort constant(short value) {
     ...
     */
    short apply(long v1, double v2, boolean v3);
}
