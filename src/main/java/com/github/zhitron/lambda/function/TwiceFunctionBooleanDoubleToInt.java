 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionBooleanDoubleToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionBooleanDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanDoubleToInt constant(int value) {
        return (v1, v2) -> value;
    }
