 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwIntLongDoubleToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToLong constant(long value) {
     ...
     */
    long apply(int v1, int v2, long v3, double v4);
}
