 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionBooleanLongToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionBooleanLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanLongToFloat constant(float value) {
        return (v1, v2) -> value;
    }
