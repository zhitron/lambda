 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionBooleanToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionBooleanToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanToShort constant(short value) {
        return (v1, v2) -> value;
    }
