 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionIntLongIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionIntLongIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongIntToLong constant(long value) {
     ...
     */
    long apply(int v1, long v2, int v3);
}
