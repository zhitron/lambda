 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwLongTwDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwLongTwDoubleToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwLongTwDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwLongTwDoubleToLong constant(long value) {
     ...
     */
    long apply(long v1, long v2, double v3, double v4);
}
