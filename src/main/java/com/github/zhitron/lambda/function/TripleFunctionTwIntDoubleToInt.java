 ...
 */
@FunctionalInterface
public interface TripleFunctionTwIntDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwIntDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwIntDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwIntDoubleToInt constant(int value) {
     ...
     */
    int apply(int v1, int v2, double v3);
}
