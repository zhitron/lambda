 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleLongIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleLongIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongIntToInt constant(int value) {
     ...
     */
    int apply(double v1, long v2, int v3);
}
