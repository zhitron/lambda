 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionDoubleIntToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionDoubleIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleIntToByte constant(byte value) {
        return (v1, v2) -> value;
    }
