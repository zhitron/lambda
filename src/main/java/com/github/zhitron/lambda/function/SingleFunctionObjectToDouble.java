 ...
 */
@FunctionalInterface
public interface SingleFunctionObjectToDouble<T> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    SingleFunctionObjectToDouble<?> EMPTY = (v1) -> BasicConstant.DOUBLE_ZERO;
    ...
    static <T> SingleFunctionObjectToDouble<T> empty() {
        return (SingleFunctionObjectToDouble<T>) EMPTY;
    }
     ...
     */
    static <T> SingleFunctionObjectToDouble<T> constant(double value) {
        return (v1) -> value;
    }
