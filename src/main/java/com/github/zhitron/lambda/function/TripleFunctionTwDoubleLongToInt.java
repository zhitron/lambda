 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleLongToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwDoubleLongToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwDoubleLongToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleLongToInt constant(int value) {
     ...
     */
    int apply(double v1, double v2, long v3);
}
