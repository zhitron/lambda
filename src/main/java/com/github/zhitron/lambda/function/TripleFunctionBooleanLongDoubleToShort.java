 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanLongDoubleToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanLongDoubleToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanLongDoubleToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanLongDoubleToShort constant(short value) {
     ...
     */
    short apply(boolean v1, long v2, double v3);
}
