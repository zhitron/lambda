 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntDoubleBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntDoubleBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleBooleanToChar constant(char value) {
     ...
     */
    char apply(int v1, double v2, boolean v3);
}
