 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleLongToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionDoubleLongToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionDoubleLongToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleLongToDouble constant(double value) {
        return (v1, v2) -> value;
    }
