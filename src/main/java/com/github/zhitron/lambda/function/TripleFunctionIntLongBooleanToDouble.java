 ...
 */
@FunctionalInterface
public interface TripleFunctionIntLongBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntLongBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntLongBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntLongBooleanToDouble constant(double value) {
     ...
     */
    double apply(int v1, long v2, boolean v3);
}
