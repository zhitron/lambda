 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    QuadrupleFunctionTwIntTwBooleanToLong EMPTY = (v1, v2, v3, v4) -> BasicConstant.LONG_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwBooleanToLong constant(long value) {
     ...
     */
    long apply(int v1, int v2, boolean v3, boolean v4);
}
