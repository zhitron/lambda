 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionBooleanDoubleToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionBooleanDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanDoubleToFloat constant(float value) {
        return (v1, v2) -> value;
    }
