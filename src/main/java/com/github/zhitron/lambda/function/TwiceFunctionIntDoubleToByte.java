 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntDoubleToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TwiceFunctionIntDoubleToByte EMPTY = (v1, v2) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TwiceFunctionIntDoubleToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntDoubleToByte constant(byte value) {
        return (v1, v2) -> value;
    }
