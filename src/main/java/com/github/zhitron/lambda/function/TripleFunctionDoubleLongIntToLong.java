 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleLongIntToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleLongIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongIntToLong constant(long value) {
     ...
     */
    long apply(double v1, long v2, int v3);
}
