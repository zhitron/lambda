 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntDoubleToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongIntDoubleToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongIntDoubleToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntDoubleToLong constant(long value) {
     ...
     */
    long apply(long v1, int v2, double v3);
}
