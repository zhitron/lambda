 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongTwDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionLongTwDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwDoubleToFloat constant(float value) {
     ...
     */
    float apply(long v1, double v2, double v3);
}
