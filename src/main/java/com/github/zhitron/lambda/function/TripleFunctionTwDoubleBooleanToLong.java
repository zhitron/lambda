 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwDoubleBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwDoubleBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleBooleanToLong constant(long value) {
     ...
     */
    long apply(double v1, double v2, boolean v3);
}
