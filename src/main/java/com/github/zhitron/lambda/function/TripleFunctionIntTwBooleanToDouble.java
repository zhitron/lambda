 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwBooleanToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionIntTwBooleanToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionIntTwBooleanToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwBooleanToDouble constant(double value) {
     ...
     */
    double apply(int v1, boolean v2, boolean v3);
}
