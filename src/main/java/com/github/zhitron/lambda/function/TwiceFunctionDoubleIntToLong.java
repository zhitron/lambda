 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleIntToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionDoubleIntToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionDoubleIntToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleIntToLong constant(long value) {
        return (v1, v2) -> value;
    }
