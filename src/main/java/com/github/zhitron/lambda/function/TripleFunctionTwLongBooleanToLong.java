 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionTwLongBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionTwLongBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongBooleanToLong constant(long value) {
     ...
     */
    long apply(long v1, long v2, boolean v3);
}
