 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwLongIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwLongIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongIntToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, int v3);
}
