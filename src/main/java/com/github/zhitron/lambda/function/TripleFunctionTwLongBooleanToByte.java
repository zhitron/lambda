 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongBooleanToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionTwLongBooleanToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionTwLongBooleanToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongBooleanToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, boolean v3);
}
