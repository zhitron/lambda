 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntTwLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    QuadrupleFunctionTwIntTwLongToShort EMPTY = (v1, v2, v3, v4) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntTwLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntTwLongToShort constant(short value) {
     ...
     */
    short apply(int v1, int v2, long v3, long v4);
}
