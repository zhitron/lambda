 ...
 * 该接口扩展自 {@link TripleFunctionLongToFloat}，增加了异常处理能力。
 *
 * @param <E> 异常类型，必须是 {@link Exception} 的子类
 * @author zhitron
 */
@FunctionalInterface
public interface TripleFunctionLongToFloatThrow<E extends Exception> extends TripleFunctionLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionLongToFloatThrow<?> EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
    ...
    static <E extends Exception> TripleFunctionLongToFloatThrow<E> empty() {
        return (TripleFunctionLongToFloatThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TripleFunctionLongToFloatThrow<E> constant(float value) {
     ...
     * @throws E 抛出执行过程中的异常
     */
    float applyThrow(long v1, long v2, long v3) throws E;
     ...
     */
    @Override
    default float apply(long v1, long v2, long v3) {
        try {
