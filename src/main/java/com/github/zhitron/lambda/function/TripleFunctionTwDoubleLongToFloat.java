 ...
 */
@FunctionalInterface
public interface TripleFunctionTwDoubleLongToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwDoubleLongToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwDoubleLongToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwDoubleLongToFloat constant(float value) {
     ...
     */
    float apply(double v1, double v2, long v3);
}
