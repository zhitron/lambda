 ...
 */
@FunctionalInterface
public interface TripleFunctionIntDoubleIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionIntDoubleIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionIntDoubleIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntDoubleIntToShort constant(short value) {
     ...
     */
    short apply(int v1, double v2, int v3);
}
