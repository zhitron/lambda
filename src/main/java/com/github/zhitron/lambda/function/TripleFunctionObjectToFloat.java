 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectToFloat<T, U, V> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionObjectToFloat<?, ?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
    ...
    static <T, U, V> TripleFunctionObjectToFloat<T, U, V> empty() {
        return (TripleFunctionObjectToFloat<T, U, V>) EMPTY;
    }
     ...
     */
    static <T, U, V> TripleFunctionObjectToFloat<T, U, V> constant(float value) {
