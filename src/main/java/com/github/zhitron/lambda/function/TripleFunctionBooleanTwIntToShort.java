 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwIntToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanTwIntToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanTwIntToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwIntToShort constant(short value) {
     ...
     */
    short apply(boolean v1, int v2, int v3);
}
