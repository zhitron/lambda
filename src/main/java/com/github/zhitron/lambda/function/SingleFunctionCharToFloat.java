 ...
 */
@FunctionalInterface
public interface SingleFunctionCharToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    SingleFunctionCharToFloat EMPTY = (v1) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static SingleFunctionCharToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionCharToFloat constant(float value) {
        return (v1) -> value;
    }
