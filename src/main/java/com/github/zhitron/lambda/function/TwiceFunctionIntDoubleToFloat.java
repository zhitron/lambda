 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TwiceFunctionIntDoubleToFloat EMPTY = (v1, v2) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TwiceFunctionIntDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntDoubleToFloat constant(float value) {
        return (v1, v2) -> value;
    }
