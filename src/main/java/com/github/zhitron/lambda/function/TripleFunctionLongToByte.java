 ...
 */
@FunctionalInterface
public interface TripleFunctionLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionLongToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongToByte constant(byte value) {
     ...
     */
    byte apply(long v1, long v2, long v3);
}
