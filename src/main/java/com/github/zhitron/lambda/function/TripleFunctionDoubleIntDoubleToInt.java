 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntDoubleToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionDoubleIntDoubleToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionDoubleIntDoubleToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntDoubleToInt constant(int value) {
     ...
     */
    int apply(double v1, int v2, double v3);
}
