 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanIntBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanIntBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanIntBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanIntBooleanToChar constant(char value) {
     ...
     */
    char apply(boolean v1, int v2, boolean v3);
}
