 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanDoubleBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionBooleanDoubleBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanDoubleBooleanToChar constant(char value) {
     ...
     */
    char apply(boolean v1, double v2, boolean v3);
}
