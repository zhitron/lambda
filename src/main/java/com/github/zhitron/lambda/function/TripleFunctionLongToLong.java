 ...
 */
@FunctionalInterface
public interface TripleFunctionLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionLongToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongToLong constant(long value) {
