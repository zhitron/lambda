 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanToObject<R> {

    /**
     * 一个空实现的实例，它总是返回 null 值。
     */
    TripleFunctionBooleanToObject<?> EMPTY = (v1, v2, v3) -> null;
    ...
    static <R> TripleFunctionBooleanToObject<R> empty() {
        return (TripleFunctionBooleanToObject<R>) EMPTY;
    }
     ...
     */
    static <R> TripleFunctionBooleanToObject<R> constant(R value) {
     ...
     */
    R apply(boolean v1, boolean v2, boolean v3);
}
