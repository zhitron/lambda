 ...
 */
@FunctionalInterface
public interface SingleFunctionLongToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    SingleFunctionLongToByte EMPTY = (v1) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static SingleFunctionLongToByte empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionLongToByte constant(byte value) {
        return (v1) -> value;
    }
