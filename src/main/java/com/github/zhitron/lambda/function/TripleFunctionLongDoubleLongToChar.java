 ...
 */
@FunctionalInterface
public interface TripleFunctionLongDoubleLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongDoubleLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongDoubleLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongDoubleLongToChar constant(char value) {
     ...
     */
    char apply(long v1, double v2, long v3);
}
