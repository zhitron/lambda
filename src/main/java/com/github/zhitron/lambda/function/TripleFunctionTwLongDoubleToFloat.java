 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionTwLongDoubleToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionTwLongDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongDoubleToFloat constant(float value) {
     ...
     */
    float apply(long v1, long v2, double v3);
}
