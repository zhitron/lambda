 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongDoubleToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionTwLongDoubleToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionTwLongDoubleToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongDoubleToChar constant(char value) {
     ...
     */
    char apply(long v1, long v2, double v3);
}
