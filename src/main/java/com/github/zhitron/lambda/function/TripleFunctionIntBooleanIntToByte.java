 ...
 */
@FunctionalInterface
public interface TripleFunctionIntBooleanIntToByte {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionIntBooleanIntToByte EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
     ...
     */
    static TripleFunctionIntBooleanIntToByte empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntBooleanIntToByte constant(byte value) {
     ...
     */
    byte apply(int v1, boolean v2, int v3);
}
