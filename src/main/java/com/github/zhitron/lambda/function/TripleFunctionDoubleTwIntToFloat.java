 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleTwIntToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    TripleFunctionDoubleTwIntToFloat EMPTY = (v1, v2, v3) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static TripleFunctionDoubleTwIntToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleTwIntToFloat constant(float value) {
     ...
     */
    float apply(double v1, int v2, int v3);
}
