...
public interface TwiceFunctionDoubleIntToLongThrow<E extends Exception> extends TwiceFunctionDoubleIntToLong {
     ...
     */
    TwiceFunctionDoubleIntToLongThrow<?> EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
    ...
    static <E extends Exception> TwiceFunctionDoubleIntToLongThrow<E> empty() {
        return (TwiceFunctionDoubleIntToLongThrow<E>) EMPTY;
    }
     ...
     */
    static <E extends Exception> TwiceFunctionDoubleIntToLongThrow<E> constant(long value) {
        return (v1, v2) -> value;
    }
