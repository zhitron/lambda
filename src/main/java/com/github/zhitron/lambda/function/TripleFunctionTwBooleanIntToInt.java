 ...
 */
@FunctionalInterface
public interface TripleFunctionTwBooleanIntToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TripleFunctionTwBooleanIntToInt EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static TripleFunctionTwBooleanIntToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwBooleanIntToInt constant(int value) {
     ...
     */
    int apply(boolean v1, boolean v2, int v3);
}
