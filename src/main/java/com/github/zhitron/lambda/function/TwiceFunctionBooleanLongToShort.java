 ...
 */
@FunctionalInterface
public interface TwiceFunctionBooleanLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionBooleanLongToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionBooleanLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionBooleanLongToShort constant(short value) {
        return (v1, v2) -> value;
    }
     ...
     */
    short apply(boolean v1, long v2);
}
