 ...
 */
@FunctionalInterface
public interface TripleFunctionLongIntLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionLongIntLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionLongIntLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongIntLongToShort constant(short value) {
     ...
     */
    short apply(long v1, int v2, long v3);
}
