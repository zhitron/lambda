 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongIntToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TwiceFunctionLongIntToDouble EMPTY = (v1, v2) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TwiceFunctionLongIntToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongIntToDouble constant(double value) {
        return (v1, v2) -> value;
    }
