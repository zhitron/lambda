 ...
 */
@FunctionalInterface
public interface TripleFunctionIntTwLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionIntTwLongToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionIntTwLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionIntTwLongToChar constant(char value) {
     ...
     */
    char apply(int v1, long v2, long v3);
}
