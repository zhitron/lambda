 ...
 */
@FunctionalInterface
public interface TripleFunctionBooleanTwLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TripleFunctionBooleanTwLongToShort EMPTY = (v1, v2, v3) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TripleFunctionBooleanTwLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionBooleanTwLongToShort constant(short value) {
     ...
     */
    short apply(boolean v1, long v2, long v3);
}
