 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleLongIntToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionDoubleLongIntToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionDoubleLongIntToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleLongIntToChar constant(char value) {
     ...
     */
    char apply(double v1, long v2, int v3);
}
