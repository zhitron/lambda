 ...
 */
@FunctionalInterface
public interface TripleFunctionDoubleIntBooleanToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TripleFunctionDoubleIntBooleanToLong EMPTY = (v1, v2, v3) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TripleFunctionDoubleIntBooleanToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionDoubleIntBooleanToLong constant(long value) {
     ...
     */
    long apply(double v1, int v2, boolean v3);
}
