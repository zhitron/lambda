 ...
 */
@FunctionalInterface
public interface QuadrupleFunctionTwIntLongDoubleToFloat {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.FLOAT_ZERO 值。
     */
    QuadrupleFunctionTwIntLongDoubleToFloat EMPTY = (v1, v2, v3, v4) -> BasicConstant.FLOAT_ZERO;
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToFloat empty() {
        return EMPTY;
    }
     ...
     */
    static QuadrupleFunctionTwIntLongDoubleToFloat constant(float value) {
     ...
     */
    float apply(int v1, int v2, long v3, double v4);
}
