 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongToShort {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.SHORT_ZERO 值。
     */
    TwiceFunctionLongToShort EMPTY = (v1, v2) -> BasicConstant.SHORT_ZERO;
     ...
     */
    static TwiceFunctionLongToShort empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongToShort constant(short value) {
        return (v1, v2) -> value;
    }
