 ...
 */
@FunctionalInterface
public interface TwiceFunctionDoubleLongToLong {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.LONG_ZERO 值。
     */
    TwiceFunctionDoubleLongToLong EMPTY = (v1, v2) -> BasicConstant.LONG_ZERO;
     ...
     */
    static TwiceFunctionDoubleLongToLong empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionDoubleLongToLong constant(long value) {
        return (v1, v2) -> value;
    }
