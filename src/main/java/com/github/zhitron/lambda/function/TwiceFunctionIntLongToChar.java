 ...
 */
@FunctionalInterface
public interface TwiceFunctionIntLongToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TwiceFunctionIntLongToChar EMPTY = (v1, v2) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TwiceFunctionIntLongToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionIntLongToChar constant(char value) {
        return (v1, v2) -> value;
    }
