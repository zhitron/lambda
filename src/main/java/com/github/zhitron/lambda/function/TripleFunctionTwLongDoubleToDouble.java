 ...
 */
@FunctionalInterface
public interface TripleFunctionTwLongDoubleToDouble {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.DOUBLE_ZERO 值。
     */
    TripleFunctionTwLongDoubleToDouble EMPTY = (v1, v2, v3) -> BasicConstant.DOUBLE_ZERO;
     ...
     */
    static TripleFunctionTwLongDoubleToDouble empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionTwLongDoubleToDouble constant(double value) {
     ...
     */
    double apply(long v1, long v2, double v3);
}
