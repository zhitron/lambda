 ...
 */
@FunctionalInterface
public interface TripleFunctionLongTwBooleanToChar {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.CHAR_ZERO 值。
     */
    TripleFunctionLongTwBooleanToChar EMPTY = (v1, v2, v3) -> BasicConstant.CHAR_ZERO;
     ...
     */
    static TripleFunctionLongTwBooleanToChar empty() {
        return EMPTY;
    }
     ...
     */
    static TripleFunctionLongTwBooleanToChar constant(char value) {
     ...
     */
    char apply(long v1, boolean v2, boolean v3);
}
