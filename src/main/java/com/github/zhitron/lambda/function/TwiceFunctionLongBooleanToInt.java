 ...
 */
@FunctionalInterface
public interface TwiceFunctionLongBooleanToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    TwiceFunctionLongBooleanToInt EMPTY = (v1, v2) -> BasicConstant.INT_ZERO;
     ...
     */
    static TwiceFunctionLongBooleanToInt empty() {
        return EMPTY;
    }
     ...
     */
    static TwiceFunctionLongBooleanToInt constant(int value) {
        return (v1, v2) -> value;
    }
