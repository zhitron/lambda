 ...
 */
@FunctionalInterface
public interface SingleFunctionShortToInt {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    SingleFunctionShortToInt EMPTY = (v1) -> BasicConstant.INT_ZERO;
     ...
     */
    static SingleFunctionShortToInt empty() {
        return EMPTY;
    }
     ...
     */
    static SingleFunctionShortToInt constant(int value) {
        return (v1) -> value;
    }
