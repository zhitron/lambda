 ...
 */
@FunctionalInterface
public interface TripleFunctionObjectToByte<T, U, V> {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.BYTE_ZERO 值。
     */
    TripleFunctionObjectToByte<?, ?, ?> EMPTY = (v1, v2, v3) -> BasicConstant.BYTE_ZERO;
    ...
    static <T, U, V> TripleFunctionObjectToByte<T, U, V> empty() {
        return (TripleFunctionObjectToByte<T, U, V>) EMPTY;
    }
     ...
     */
    static <T, U, V> TripleFunctionObjectToByte<T, U, V> constant(byte value) {
