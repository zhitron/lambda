...
public interface TwicePredicateDouble {
    ...
    /**
     * 默认返回 true 的 TwicePredicateDouble 实例。
     */
    TwicePredicateDouble DEFAULT_TRUE = (v1, v2) -> BasicConstant.BOOLEAN_TRUE;

    /**
     * 默认返回 false 的 TwicePredicateDouble 实例。
     */
    TwicePredicateDouble DEFAULT_FALSE = (v1, v2) -> BasicConstant.BOOLEAN_FALSE;

    /**
     * 根据给定的布尔值返回对应的默认 TwicePredicateDouble 实例。
     *
     * @param value 给定的布尔值。
     * @return 如果 value 为 true，返回 DEFAULT_TRUE；否则返回 DEFAULT_FALSE。
     */
    static TwicePredicateDouble constant(boolean value) {
