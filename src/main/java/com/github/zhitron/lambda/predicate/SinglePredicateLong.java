...
public interface SinglePredicateLong {
    ...
    /**
     * 默认返回 true 的 SinglePredicateLong 实例。
     */
    SinglePredicateLong DEFAULT_TRUE = (v1) -> BasicConstant.BOOLEAN_TRUE;

    /**
     * 默认返回 false 的 SinglePredicateLong 实例。
     */
    SinglePredicateLong DEFAULT_FALSE = (v1) -> BasicConstant.BOOLEAN_FALSE;

    /**
     * 根据给定的布尔值返回对应的默认 SinglePredicateLong 实例。
     *
     * @param value 给定的布尔值。
     * @return 如果 value 为 true，返回 DEFAULT_TRUE；否则返回 DEFAULT_FALSE。
     */
    static SinglePredicateLong constant(boolean value) {
