...
public interface QuadruplePredicateTwBooleanLongDouble {
    ...
    /**
     * 默认返回 true 的 QuadruplePredicateTwBooleanLongDouble 实例。
     */
    QuadruplePredicateTwBooleanLongDouble DEFAULT_TRUE = (v1, v2, v3, v4) -> BasicConstant.BOOLEAN_TRUE;

    /**
     * 默认返回 false 的 QuadruplePredicateTwBooleanLongDouble 实例。
     */
    QuadruplePredicateTwBooleanLongDouble DEFAULT_FALSE = (v1, v2, v3, v4) -> BasicConstant.BOOLEAN_FALSE;

    /**
     * 根据给定的布尔值返回对应的默认 QuadruplePredicateTwBooleanLongDouble 实例。
     *
     * @param value 给定的布尔值。
     * @return 如果 value 为 true，返回 DEFAULT_TRUE；否则返回 DEFAULT_FALSE。
     */
    static QuadruplePredicateTwBooleanLongDouble constant(boolean value) {
