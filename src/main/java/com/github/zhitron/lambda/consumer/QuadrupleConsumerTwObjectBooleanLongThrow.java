...
public interface QuadrupleConsumerTwObjectBooleanLongThrow<T, U, E extends Exception> extends QuadrupleConsumerTwObjectBooleanLong<T, U> {
     ...
     * 一个空实现的实例，它总是返回 。
     */
    QuadrupleConsumerTwObjectBooleanLongThrow<?, ?, ?> EMPTY = (v1, v2, v3, v4) -> {
    };
    ...
    static <T, U, E extends Exception> QuadrupleConsumerTwObjectBooleanLongThrow<T, U, E> empty() {
        return (QuadrupleConsumerTwObjectBooleanLongThrow<T, U, E>) EMPTY;
    }
