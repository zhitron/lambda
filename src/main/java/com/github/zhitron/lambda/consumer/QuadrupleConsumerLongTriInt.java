 ...
 */
@FunctionalInterface
public interface QuadrupleConsumerLongTriInt {

    /**
     * 一个空实现的实例，它总是返回 。
     */
    QuadrupleConsumerLongTriInt EMPTY = (v1, v2, v3, v4) -> {
    };
     ...
     */
    static QuadrupleConsumerLongTriInt empty() {
        return EMPTY;
    }
     ...
     */
    void accept(long v1, int v2, int v3, int v4);
}
