 ...
 */
@FunctionalInterface
public interface QuadrupleConsumerTwLongTwInt {

    /**
     * 一个空实现的实例，它总是返回 。
     */
    QuadrupleConsumerTwLongTwInt EMPTY = (v1, v2, v3, v4) -> {
    };
     ...
     */
    static QuadrupleConsumerTwLongTwInt empty() {
        return EMPTY;
    }
     ...
     */
    void accept(long v1, long v2, int v3, int v4);
}
