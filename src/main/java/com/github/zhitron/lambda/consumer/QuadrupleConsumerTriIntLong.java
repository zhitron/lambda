 ...
 */
@FunctionalInterface
public interface QuadrupleConsumerTriIntLong {

    /**
     * 一个空实现的实例，它总是返回 。
     */
    QuadrupleConsumerTriIntLong EMPTY = (v1, v2, v3, v4) -> {
    };
     ...
     */
    static QuadrupleConsumerTriIntLong empty() {
        return EMPTY;
    }
     ...
     */
    void accept(int v1, int v2, int v3, long v4);
}
