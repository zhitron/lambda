 ...
 */
@FunctionalInterface
public interface QuadrupleConsumerTriLongInt {

    /**
     * 一个空实现的实例，它总是返回 。
     */
    QuadrupleConsumerTriLongInt EMPTY = (v1, v2, v3, v4) -> {
    };
     ...
     */
    static QuadrupleConsumerTriLongInt empty() {
        return EMPTY;
    }
     ...
     */
    void accept(long v1, long v2, long v3, int v4);
}
