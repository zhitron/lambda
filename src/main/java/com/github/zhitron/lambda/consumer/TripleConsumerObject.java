 ...
 */
@FunctionalInterface
public interface TripleConsumerObject<T, U, V> {

    /**
     * 一个空实现的实例，它总是返回 。
     */
    TripleConsumerObject<?, ?, ?> EMPTY = (v1, v2, v3) -> {
    };
    ...
    static <T, U, V> TripleConsumerObject<T, U, V> empty() {
        return (TripleConsumerObject<T, U, V>) EMPTY;
    }
