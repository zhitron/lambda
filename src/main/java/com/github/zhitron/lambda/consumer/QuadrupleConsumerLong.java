 ...
 */
@FunctionalInterface
public interface QuadrupleConsumerLong {

    /**
     * 一个空实现的实例，它总是返回 。
     */
    QuadrupleConsumerLong EMPTY = (v1, v2, v3, v4) -> {
    };
     ...
     */
    static QuadrupleConsumerLong empty() {
        return EMPTY;
    }
     ...
     */
    void accept(long v1, long v2, long v3, long v4);
}
