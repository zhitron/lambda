 ...
 */
@FunctionalInterface
public interface QuadrupleConsumerTwIntTwLong {

    /**
     * 一个空实现的实例，它总是返回 。
     */
    QuadrupleConsumerTwIntTwLong EMPTY = (v1, v2, v3, v4) -> {
    };
     ...
     */
    static QuadrupleConsumerTwIntTwLong empty() {
        return EMPTY;
    }
     ...
     */
    void accept(int v1, int v2, long v3, long v4);
}
