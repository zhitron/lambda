 ...
 */
@FunctionalInterface
public interface QuadrupleConsumerIntTriLong {

    /**
     * 一个空实现的实例，它总是返回 。
     */
    QuadrupleConsumerIntTriLong EMPTY = (v1, v2, v3, v4) -> {
    };
     ...
     */
    static QuadrupleConsumerIntTriLong empty() {
        return EMPTY;
    }
     ...
     */
    void accept(int v1, long v2, long v3, long v4);
}
