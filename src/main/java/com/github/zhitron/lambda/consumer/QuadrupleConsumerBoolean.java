 ...
 */
@FunctionalInterface
public interface QuadrupleConsumerBoolean {

    /**
     * 一个空实现的实例，它总是返回 。
     */
    QuadrupleConsumerBoolean EMPTY = (v1, v2, v3, v4) -> {
    };
     ...
     */
    static QuadrupleConsumerBoolean empty() {
        return EMPTY;
    }
     ...
     */
    void accept(boolean v1, boolean v2, boolean v3, boolean v4);
}
