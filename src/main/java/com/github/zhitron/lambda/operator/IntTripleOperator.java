...
/**
 * 这是一个通用的 lambda 函数接口，用于对 3 个 int 类型参数进行操作。。
 *
 * @author zhitron
 */
@FunctionalInterface
public interface IntTripleOperator {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    IntTripleOperator EMPTY = (v1, v2, v3) -> BasicConstant.INT_ZERO;
     ...
     */
    static IntTripleOperator empty() {
        return EMPTY;
    }
     ...
     */
    static IntTripleOperator constant(int value) {
