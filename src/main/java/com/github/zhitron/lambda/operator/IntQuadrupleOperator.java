...
/**
 * 这是一个通用的 lambda 函数接口，用于对 4 个 int 类型参数进行操作。。
 *
 * @author zhitron
 */
@FunctionalInterface
public interface IntQuadrupleOperator {

    /**
     * 一个空实现的实例，它总是返回 BasicConstant.INT_ZERO 值。
     */
    IntQuadrupleOperator EMPTY = (v1, v2, v3, v4) -> BasicConstant.INT_ZERO;
     ...
     */
    static IntQuadrupleOperator empty() {
        return EMPTY;
    }
     ...
     */
    static IntQuadrupleOperator constant(int value) {
